if (typeof jwplayer == "undefined") {
  ...
  (function (b) {
    ...
    b.utils.useNativeFullscreen = function () {
      return (
        navigator && navigator.vendor && navigator.vendor.indexOf("Apple") == 0
      );
    };
  ...
  (function (jwplayer) {
    jwplayer.events.eventdispatcher = function (debug) {
      ...
      this.removeEventListener = function (type, listener) {
        ...
        try {
          for (
            ...
            if (
              _listeners[type][listenerIndex].listener.toString() ==
              listener.toString()
            ) {
      ...
      this.removeGlobalListener = function (listener) {
        ...
        try {
          for (
            var globalListenerIndex = 0;
            globalListenerIndex < _globallisteners.length;
            globalListenerIndex++
          ) {
            if (
              _globallisteners[globalListenerIndex].listener.toString() ==
              listener.toString()
            ) {
      ...
      this.sendEvent = function (type, data) {
            ...
            if (_listeners[type][listenerIndex]) {
              if (_listeners[type][listenerIndex].count === 1) {
                ...
                if (_listeners[type][listenerIndex].count > 0) {
                  _listeners[type][listenerIndex].count =
                    _listeners[type][listenerIndex].count - 1;
                }
              }
            }
          }
        ...
        for (
          ...
          try {
            ...
            jwplayer.utils.log(
              "There was an error while handling a listener: " + err.toString(),
  ...
  (function (a) {
      ...
      for (var b = 0; b < c.childNodes.length; b++) {
        if (c.childNodes[b].prefix == a.utils.parsers.jwparser.PREFIX) {
          d[a.utils.parsers.localName(c.childNodes[b])] =
            a.utils.strings.serialize(
              a.utils.parsers.textContent(c.childNodes[b])
            );
          if (
            a.utils.parsers.localName(c.childNodes[b]) == "file" &&
            d.levels
          ) {
            delete d.levels;
          }
    ...
    a.utils.parsers.jwparser.getProvider = function (c) {
      if (c.type) {
        ...
        if (
          c.file.indexOf("youtube.com/w") > -1 ||
          ...
          switch (a.utils.parsers.localName(d.childNodes[c]).toLowerCase()) {
            case "content":
              ...
              if (a.utils.strings.xmlAttribute(d.childNodes[c], "duration")) {
                f.duration = a.utils.strings.seconds(
                  a.utils.strings.xmlAttribute(d.childNodes[c], "duration")
                );
              }
              if (a.utils.strings.xmlAttribute(d.childNodes[c], "start")) {
                f.start = a.utils.strings.seconds(
                  a.utils.strings.xmlAttribute(d.childNodes[c], "start")
                );
              }
              if (
                d.childNodes[c].childNodes &&
                d.childNodes[c].childNodes.length > 0
              ) {
                f = a.utils.parsers.mediaparser.parseGroup(d.childNodes[c], f);
              }
              if (
                a.utils.strings.xmlAttribute(d.childNodes[c], "width") ||
  ...
  (function (b) {
    ...
    b.utils.parsers.rssparser.parse = function (f) {
      ...
      for (var e = 0; e < f.childNodes.length; e++) {
        if (
          b.utils.parsers.localName(f.childNodes[e]).toLowerCase() == "channel"
        ) {
          for (var d = 0; d < f.childNodes[e].childNodes.length; d++) {
            if (
              b.utils.parsers
                .localName(f.childNodes[e].childNodes[d])
                .toLowerCase() == "item"
            ) {
      ...
      function j() {
        if (!b) {
          ...
          for (plugin in g) {
            ...
            if (
              l == a.utils.loaderstatus.LOADING ||
    ...
    b.api = function (d) {
      ...
      this.setFullscreen = function (u) {
        if (!b.utils.exists(u)) {
          this.callInternal(
            "jwSetFullscreen",
            !this.callInternal("jwGetFullscreen")
          );
        } else {
      ...
      this.onBeforeComplete = function (u) {
        return this.eventListener(
          b.api.events.JWPLAYER_MEDIA_BEFORECOMPLETE,
          u
        );
      };
  ...
  var _userPlayerReady =
    typeof playerReady == "function" ? playerReady : undefined;
        ...
        if (j.getStatus() == c.loaderstatus.COMPLETE) {
          for (var n = 0; n < f.modes.length; n++) {
            if (f.modes[n].type && a.embed[f.modes[n].type]) {
              ...
              var r = new a.embed[f.modes[n].type](
          ...
          new a.embed.logo(
            c.extend({ hide: true }, f.components.logo),
            "none",
            h.id
          );
        }
  ...
  (function (e) {
    ...
    function c(m) {
      var l = false;
      l =
        m instanceof Array || (typeof m == "object" && !m.position && !m.size);
      return l;
    }
    function j(l) {
      if (typeof l == "string") {
  ...
  (function (a) {
    a.embed.download = function (c, g, b, d, f) {
      this.embed = function () {
        ...
        q.display.appendChild(
          new a.embed.logo(b.components.logo, "download", c.id)
        );
  ...
  (function (a) {
    a.embed.flash = function (f, g, l, e, j) {
        ...
        for (var o in p) {
          if (typeof p[o] == "object") {
            n +=
              ...
              "=" +
              encodeURIComponent(
                "[[JSON]]" + a.utils.strings.jsonToString(p[o])
              ) +
              "&";
          } else {
      ...
      this.embed = function () {
        ...
        if (a.utils.isIE()) {
          var w =
            '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" bgcolor="' +
            z +
      ...
      flashCanPlay = function (n, p) {
        ...
        if (
          a.utils.exists(a.utils.extensionmap[q]) &&
  ...
  (function (a) {
    ...
    a.html5.view = function (l, D, g) {
      ...
      function H() {
        ...
        function P() {
          if (
            k.skin.getComponentSettings("display") &&
      ...
      function G() {
        for (var P = 0; P < h.plugins.order.length; P++) {
          ...
          if (c.exists(h.plugins.object[Q].getDisplayElement)) {
            h.plugins.object[Q].height = c.parseDimension(
              h.plugins.object[Q].getDisplayElement().style.height
            );
            h.plugins.object[Q].width = c.parseDimension(
              h.plugins.object[Q].getDisplayElement().style.width
            );
        ...
        if (c.exists(S)) {
          ...
          for (var P = 0; P < h.plugins.order.length; P++) {
            ...
            if (c.exists(h.plugins.object[R].getDisplayElement)) {
              h.plugins.config[R].currentPosition =
                h.plugins.config[R].position;
            }
          }
        }
        C(h.width, h.height);
      ...
      function I(P) {
        switch (P.keyCode) {
          ...
          case 32:
            if (
              k.jwGetState() != a.api.events.state.IDLE &&
      ...
      function C(P, Y) {
        ...
        if (!h.fullscreen) {
          ...
          if (typeof P == "string" && P.indexOf("%") > 0) {
            f =
              (c.getElementWidth(c.parentNode(M)) *
                parseInt(P.replace("%"), "")) /
              100;
          } else {
            f = P;
          ...
          if (typeof Y == "string" && Y.indexOf("%") > 0) {
            q =
              (c.getElementHeight(c.parentNode(M)) *
                parseInt(Y.replace("%"), "")) /
              100;
          } else {
            q = Y;
      ...
      function t(W, S, T) {
        ...
        for (var R = 0; R < S.length; R++) {
          ...
          if (c.exists(h.plugins.object[V].getDisplayElement)) {
            if (
              h.plugins.config[V].currentPosition != a.html5.view.positions.NONE
            ) {
              var P = W(V, B--);
              if (!P) {
                U.push(V);
      ...
      var j = (this.resizeMedia = function () {
        ...
        if (R && R.tagName.toLowerCase() == "video") {
          ...
          if (
            ...
            c.stretch(
              a.utils.stretching.EXACTFIT,
              R,
              c.parseDimension(P.style.width),
              c.parseDimension(P.style.height),
          ...
          if (Q) {
            h.getMedia().resize(
              c.parseDimension(Q.style.width),
              c.parseDimension(Q.style.height)
            );
          } else {
            h.getMedia().resize(
              c.parseDimension(m.style.width),
      ...
      var w = (this.getComponentPosition = function (Q) {
        ...
        switch (P.toUpperCase()) {
          case a.html5.view.positions.TOP:
            ...
            m.style[P] =
              c.parseDimension(m.style[P]) + h.plugins.object[Q].height + "px";
          ...
          case a.html5.view.positions.LEFT:
            ...
            R.height =
              ...
              c.parseDimension(m.style.bottom);
            m.style[P] =
              c.parseDimension(m.style[P]) + h.plugins.object[Q].width + "px";
            m.style.width = c.getElementWidth(m) - R.width + "px";
            break;
          default:
            break;
      ...
      function y() {
        if (
          ...
          !A &&
          h.getMedia() &&
          h.getMedia().getDisplayElement() &&
          h.getMedia().getDisplayElement().webkitSupportsFullscreen &&
  ...
  (function (a) {
    var b = {
      ...
      layout: {
        ...
        center: {
          position: "center",
          elements: [{ name: "time", type: "slider" }],
        },
        right: {
          position: "right",
          elements: [
    ...
    a.html5.controlbar = function (m, X) {
      ...
      var D = _utils.extend(
        {},
        b,
        l.skin.getComponentSettings("controlbar"),
        X
      );
      if (
        D.position == a.html5.view.positions.NONE ||
      ...
      function C(aq, at, av) {
        ...
        switch (aq.name) {
          ...
          case "time":
            an = !_utils.exists(
              l.skin.getSkinElement("controlbar", "timeSliderCapLeft")
            )
              ? 0
              : l.skin.getSkinElement("controlbar", "timeSliderCapLeft").width;
            ao = !_utils.exists(
              l.skin.getSkinElement("controlbar", "timeSliderCapRight")
            )
              ? 0
          ...
          case "volume":
            an = !_utils.exists(
              l.skin.getSkinElement("controlbar", "volumeSliderCapLeft")
            )
              ? 0
              : l.skin.getSkinElement("controlbar", "volumeSliderCapLeft")
                  .width;
            ao = !_utils.exists(
              l.skin.getSkinElement("controlbar", "volumeSliderCapRight")
            )
              ? 0
              : l.skin.getSkinElement("controlbar", "volumeSliderCapRight")
                  .width;
            ap = at == "left" ? an : ao;
            am =
              l.skin.getSkinElement("controlbar", "volumeSliderRail").width +
              an +
              ao;
            aw = {
              height: K().height,
      ...
      function y(ap, at, an, aw, aq, am, ao) {
        if (
          _utils.exists(l.skin.getSkinElement("controlbar", ap)) ||
          ap.indexOf("Text") > 0 ||
          ...
          if (
            (ap.indexOf("next") === 0 || ap.indexOf("prev") === 0) &&
            (l.jwGetPlaylist().length < 2 ||
              D.hideplaylistcontrols.toString() == "true")
          ) {
          ...
          if (q) {
            ...
            var av = ac(ap, aw, ar);
            if (
              _utils.exists(l.skin.getSkinElement("controlbar", ap + "Over"))
            ) {
      ...
      function aj(an) {
        ...
        if (w == "time") {
          ...
          if (
            l.jwGetState() == a.api.events.state.PAUSED ||
      ...
      function v(an) {
        ...
        if (c.timeSliderRail) {
          ...
          var am = isNaN(Math.round((ao * g) / 100))
            ? 0
            : Math.round((ao * g) / 100);
      ...
      function s(am) {
        if (
          am.newstate == a.api.events.state.BUFFERING ||
      ...
      function J(aq) {
        ...
        if (at) {
          var an = isNaN(Math.round(at.width * ao))
            ? 0
            : Math.round(at.width * ao);
      ...
      function o() {
        ...
        for (var ao = 0; ao < am.length; ao++) {
          ...
          for (var an in aq) {
            ...
            if (
              aq[an].id.indexOf(af.id + "_divider") === 0 &&
              ap &&
      ...
      function ai() {
        ...
        if (
          l.jwGetState() == a.api.events.state.BUFFERING ||
        ...
        if (_utils.exists(R.volumeSliderRail)) {
          ...
          if (R.volumeSliderThumb) {
            var aq =
              am -
              Math.round(
                _utils.parseDimension(R.volumeSliderThumb.style.width) / 2
              );
            aq = Math.min(
              Math.max(aq, 0),
              ap - _utils.parseDimension(R.volumeSliderThumb.style.width)
            );
      ...
      function S() {
        try {
          var an =
            l.id.indexOf("_instream") > 0
              ? l.id.replace("_instream", "")
              : l.id;
  ...
  (function (b) {
    ...
    b.html5.controller = function (o, K, f, h) {
      var n = o,
        ...
        q = false;
      var D =
          c.exists(m.config.debug) &&
          m.config.debug.toString().toLowerCase() == "console",
      ...
      function R(T) {
        try {
          ...
          if (m.playlist[m.item].provider) {
            v(m.item);
            if (
              m.config.autostart.toString().toLowerCase() == "true" &&
              !c.isIOS() &&
              !A
            ) {
              F();
  ...
  (function (a) {
    ...
    a.html5.display = function (k, K) {
      ...
      var H = {
        display: {
          style: { cursor: "pointer", top: 0, left: 0, overflow: "hidden" },
          click: n,
        },
        display_icon: {
          style: {
            ...
            position: "absolute",
            top:
              (h.skin.getSkinElement("display", "background").height -
                h.skin.getSkinElement("display", "playIcon").height) /
              2,
            left:
              (h.skin.getSkinElement("display", "background").width -
        ...
        display_iconBackground: {
          style: {
            ...
            position: "absolute",
            top:
              (w - h.skin.getSkinElement("display", "background").height) / 2,
            left:
              (e - h.skin.getSkinElement("display", "background").width) / 2,
            border: 0,
            backgroundImage: [
              "url(",
      ...
      function r(Y) {
        ...
        W.display_text.style.top =
          (w - _utils.getBoundingClientRect(W.display_text).height) / 2 + "px";
      }
      function I() {
        V = false;
      ...
      function q(Y) {
        if (
          (Y.type == a.api.events.JWPLAYER_PLAYER_STATE ||
            Y.type == a.api.events.JWPLAYER_PLAYLIST_ITEM) &&
          E
        ) {
          E = false;
        ...
        if (
          O ||
          h.jwGetState() == a.api.events.state.PLAYING ||
      ...
      function t(Y) {
        ...
        switch (Y) {
          ...
          case a.api.events.state.IDLE:
            if (
              h.jwGetPlaylist()[h.jwGetPlaylistIndex()] &&
          ...
          if (H) {
            ...
            if (!j[K].div) {
              ...
              if (w.skin.getSkinElement("dock", "button")) {
                j[K].div.childNodes[1].src = w.skin.getSkinElement(
                  "dock",
                  "button"
                ).src;
              }
      ...
      function l(H, T) {
        ...
        if (A.length > 0) {
          ...
          for (var J = 0; J < A.length; J++) {
            ...
            K.style.left =
              M +
              (w.skin.getSkinElement("dock", "button").width + I) * U * P +
              "px";
            var N = {
  ...
  (function (a) {
    ...
    a.html5.instream = function (y, m, x, z) {
      ...
      this.load = function (M, K) {
        ...
        if (!b.isMobile()) {
          l = new a.html5.controlbar(
            n,
            b.extend({}, E.plugins.config.controlbar, {})
          );
          if (
            E.plugins.config.controlbar.position == a.html5.view.positions.OVER
          ) {
      ...
      this.jwInstreamDestroy = function (K) {
        ...
        D(
          a.api.events.JWPLAYER_INSTREAM_DESTROYED,
      ...
      function p() {
        ...
        if (l) {
          ...
          _css(
            l.getDisplayElement(),
            b.extend({}, L, { zIndex: 1001, opacity: 1 })
          );
        }
        if (q) {
  ...
  (function (b) {
    ...
    b.html5.mediavideo = function (h, F) {
      ...
      function D(W) {
        ...
        if (e.useNativeFullscreen() && e.exists(m.webkitDisplayingFullscreen)) {
          if (j.fullscreen != m.webkitDisplayingFullscreen) {
            s(
              b.api.events.JWPLAYER_FULLSCREEN,
      ...
      function N(V) {
        ...
        if (e.exists(V) && e.exists(V.target)) {
          ...
          if (f == b.api.events.state.PLAYING) {
            ...
            j.position =
              j.duration > 0 ? Math.round(V.target.currentTime * 10) / 10 : 0;
            s(b.api.events.JWPLAYER_MEDIA_TIME, {
              position: j.position,
              duration: j.duration,
            });
            if (
              j.position >= j.duration &&
      ...
      function o(W) {
        ...
        if (
          (W.target.error && W.target.tagName.toLowerCase() == "video") ||
          (W.target.parentNode.error &&
            W.target.parentNode.tagName.toLowerCase() == "video")
        ) {
          var U = !e.exists(W.target.error)
            ? W.target.parentNode.error
            : W.target.error;
          switch (U.code) {
    ...
    jwplayer.html5.model = function (api, container, options) {
      ...
      var _model = {
        ...
        config: {
          ...
          mute:
            _cookies.mute && _cookies.mute.toString().toLowerCase() == "true"
              ? true
              : false,
          fullscreen: false,
          repeat: "",
      ...
      for (var index in _configurableStateVariables) {
        ...
        _model[configurableStateVariable] =
          _model.config[configurableStateVariable];
      }
        ...
        if (typeof _model.plugins == "string") {
          ...
          for (var userplugin in userplugins) {
            if (typeof userplugins[userplugin] == "string") {
              pluginorder.push(
                userplugins[userplugin].replace(/^\s+|\s+$/g, "")
              );
            }
          }
        }
      ...
      if (typeof _model.config.components != "undefined") {
        for (var component in _model.config.components) {
          _model.plugins.config[component] =
            _model.config.components[component];
        }
      }
      var playlistVisible = false;
      for (var pluginIndex in _model.plugins.order) {
        var pluginName = _model.plugins.order[pluginIndex];
        var pluginConfig = !jwplayer.utils.exists(
          _model.plugins.config[pluginName]
        )
          ? {}
          : _model.plugins.config[pluginName];
        _model.plugins.config[pluginName] = !jwplayer.utils.exists(
          _model.plugins.config[pluginName]
        )
          ? pluginConfig
        ...
        if (
          !jwplayer.utils.exists(_model.plugins.config[pluginName].position)
        ) {
          if (pluginName == "playlist") {
            _model.plugins.config[pluginName].position =
              jwplayer.html5.view.positions.NONE;
          } else {
            _model.plugins.config[pluginName].position =
              jwplayer.html5.view.positions.OVER;
          }
        } else {
          if (pluginName == "playlist") {
            playlistVisible = true;
          }
          _model.plugins.config[pluginName].position = _model.plugins.config[
            pluginName
          ].position
            .toString()
            .toUpperCase();
      ...
      if (typeof _model.plugins.config.dock != "undefined") {
        ...
        if (typeof _model.plugins.config.dock.position != "undefined") {
          _model.plugins.config.dock.align =
            _model.plugins.config.dock.position;
          _model.plugins.config.dock.position =
            jwplayer.html5.view.positions.OVER;
        }
        if (typeof _model.plugins.config.dock.idlehide == "undefined") {
          try {
            _model.plugins.config.dock.idlehide =
              _model.plugins.config.controlbar.idlehide;
          } catch (e) {}
        }
      }
      function _loadExternal(playlistfile) {
        ...
        loader.addEventListener(
          jwplayer.api.events.JWPLAYER_ERROR,
          function (evt) {
      ...
      function _loadComplete() {
        ...
        _model.position = 0;
        _model.duration =
          _model.playlist.length > 0
            ? _model.playlist[_model.item].duration
            : 0;
      ...
      _model.setActiveMediaProvider = function (playlistItem) {
        ...
        if (!jwplayer.utils.exists(_mediaProviders[provider])) {
          switch (provider) {
            case "video":
              _media = new jwplayer.html5.mediavideo(
                _model,
                current ? current : _container
              );
              break;
            case "youtube":
              _media = new jwplayer.html5.mediayoutube(
                _model,
                current ? current : _container
              );
              break;
      ...
      _model.setupPlugins = function () {
        if (
          !jwplayer.utils.exists(_model.plugins) ||
        ...
        for (var i = 0; i < _model.plugins.order.length; i++) {
          try {
            ...
            if (jwplayer.utils.exists(jwplayer.html5[pluginName])) {
              if (pluginName == "playlist") {
                _model.plugins.object[pluginName] =
                  new jwplayer.html5.playlistcomponent(
                    _api,
                    _model.plugins.config[pluginName]
                  );
              } else {
                _model.plugins.object[pluginName] = new jwplayer.html5[
                  pluginName
            ...
            if (
              typeof _model.plugins.object[pluginName].addGlobalListener ==
              "function"
            ) {
  ...
  (function (a) {
    ...
    a.html5.playlistcomponent = function (r, C) {
      ...
      if (
        e.position == a.html5.view.positions.NONE ||
    ...
    a.html5.skinloader = function (f, p, k) {
      ...
      function d(y) {
        ...
        for (var H = 0; H < E.length; H++) {
          ...
          o[C] = B;
          var G =
            E[H].getElementsByTagName("elements")[0].getElementsByTagName(
              "element"
            );
            ...
            for (var w = 0; w < M.length; w++) {
              ...
              for (var v = 0; v < N.length; v++) {
                ...
                for (var u = 0; u < t.attributes.length; u++) {
                  ...
                  o[C].layout[A.getAttribute("position")].elements[v][J.name] =
                    J.value;
                }
                if (
                  !a.utils.exists(
                    o[C].layout[A.getAttribute("position")].elements[v].name
                  )
                ) {
                  o[C].layout[A.getAttribute("position")].elements[v].name =
                    t.tagName;
  ...
  (function (a) {
    a.html5.api = function (c, p) {
      ...
      function f() {
        if (
          m.state == a.api.events.state.PLAYING ||
      ...
      function o(q) {
        return function () {
          if (d && typeof d[q] == "function") {
            ...
            _utils.log(
              "Could not call instream method - instream API not initialized"
            );
          }
        };
      }
