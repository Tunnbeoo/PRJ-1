...
(function () {
  ...
  "GENERATED_CDN_VSN" !== t.Yb &&
    (videojs.options.flash.swf =
      t.ed + "vjs.zencdn.net/" + t.Yb + "/video-js.swf");
  t.sd = function (a, c) {
    t.options.languages[a] =
      t.options.languages[a] !== b ? t.Z.Ea(t.options.languages[a], c) : c;
  ...
  t.c = function (a, c, d) {
    ...
    1 == e.C[c].length &&
      (a.addEventListener
        ...
        : a.attachEvent && a.attachEvent("on" + c, e.W));
  };
  t.k = function (a, c, d) {
    if (t.Bc(a)) {
      var e = t.getData(a);
  ...
  t.pc = function (a, c) {
    ...
    0 === d.C[c].length &&
      ...
      a.removeEventListener
        ...
        : a.detachEvent && a.detachEvent("on" + c, d.W));
  ...
  A
    ? ((B = A[1] && parseFloat(A[1])),
      ...
      (z = B && C ? parseFloat(A[1] + "." + A[2]) : B ? B : k))
    : (z = k);
  ba.Xb = z;
  ...
  t.ic = !!(
    ...
    (window.gd && document instanceof window.gd)
  );
  t.fd = "backgroundSize" in t.A.style;
  t.Sc = function (a, c) {
    t.h.X(c, function (c, e) {
      e === k || "undefined" === typeof e || e === l
        ? a.removeAttribute(c)
  ...
  t.ye = function (a, c) {
    ...
    videojs.Z.Ea({ method: "GET", timeout: 45e3 }, a);
    c = c || m();
    p = function () {
  ...
  t.a = t.ua.extend({
    i: function (a, c, d) {
      ...
      this.K ||
        (this.K = ((a.id && a.id()) || "no_player") + "_component_" + t.p++);
      this.Vd = c.name || k;
      this.b = c.el || this.e();
      this.O = [];
      this.Ua = {};
  ...
  s.removeChild = function (a) {
    ...
    if (a && this.O) {
      ...
      c &&
        ...
        (this.Va[a.name] = k),
        (c = a.w()) &&
          c.parentNode === this.ma() &&
          this.ma().removeChild(a.w()));
    }
  };
  s.Dc = function () {
    var a, c, d, e, g, h;
  ...
  s.c = function (a, c, d) {
    var e, g, h;
    "string" === typeof a || t.h.isArray(a)
      ? t.c(this.b, a, t.bind(this, c))
      : ((e = t.bind(this, d)),
        (h = this),
        (g = function () {
          h.k(a, c, e);
        ...
        (d.p = e.p),
        a.nodeName
          ? (t.c(a, c, e), t.c(a, "dispose", d))
          : "function" === typeof a.c && (a.c(c, e), a.c("dispose", d)));
    return this;
  };
  s.k = function (a, c, d) {
    !a || "string" === typeof a || t.h.isArray(a)
      ? t.k(this.b, a, c)
      : ((d = t.bind(this, d)),
        this.k("dispose", d),
        a.nodeName
          ? (t.k(a, c, d), t.k(a, "dispose", d))
          : (a.k(c, d), a.k("dispose", d)));
    return this;
  };
  s.Q = function (a, c, d) {
    var e, g, h;
  ...
  s.H = function (a) {
    a &&
      (this.oa
        ? a.call(this)
        : (this.eb === b && (this.eb = []), this.eb.push(a)));
    return this;
  };
  s.Ka = function () {
    this.oa = f;
  ...
  function G(a) {
    ...
    a.c("touchstart", function (a) {
      1 === a.touches.length &&
        ((d = a.touches[0]), (c = new Date().getTime()), (g = f));
    });
    a.c("touchmove", function (a) {
      1 < a.touches.length
        ? (g = l)
        : d &&
          ((j = a.touches[0].pageX - d.pageX),
          (p = a.touches[0].pageY - d.pageY),
          (q = Math.sqrt(j * j + p * p)),
          22 < q && (g = l));
    });
    h = function () {
    ...
    a.c("touchend", function (a) {
      ...
      g === f &&
        ...
        250 > e && (a.preventDefault(), this.l("tap")));
    });
  }
  ...
  s.e = function (a, c) {
    ...
    c.innerHTML ||
      ((this.v = t.e("div", { className: "vjs-control-content" })),
      (this.xb = t.e("span", {
        className: "vjs-control-text",
        innerHTML: this.t(this.la) || "Need Text",
      })),
      this.v.appendChild(this.xb),
      d.appendChild(this.v));
    return d;
  };
  s.S = function () {
  ...
  t.J.prototype.e = function (a, c) {
    return t.u.prototype.e.call(
      this,
      "li",
      t.h.z({ className: "vjs-menu-item", innerHTML: this.t(this.m.label) }, c)
    );
  };
  ...
  t.J.prototype.selected = function (a) {
    a
      ? (this.n("vjs-selected"), this.b.setAttribute("aria-selected", f))
      : (this.r("vjs-selected"), this.b.setAttribute("aria-selected", l));
  };
  t.L = t.u.extend({
    i: function (a, c) {
      t.u.call(this, a, c);
    ...
    if (a.hasChildNodes()) {
      ...
      for (h = a.length; g < h; g++)
        (c = a[g]),
          ...
          "source" === d
            ? e.sources.push(t.Ca(c))
            : "track" === d && e.tracks.push(t.Ca(c));
    }
    return e;
  }
  s.e = function () {
  ...
  function R(a, c) {
    c !== b &&
      a.Cc !== c &&
      ((a.Cc = c)
        ? (a.n("vjs-has-started"), a.l("firstplay"))
        : a.r("vjs-has-started"));
  }
  s.Pb = function () {
    this.r("vjs-paused");
  ...
  s.Jc = function () {
    ...
    a &&
      (0 > a && (a = Infinity),
      this.duration(a),
      Infinity === a ? this.n("vjs-live") : this.r("vjs-live"));
  };
  s.Yd = function () {
  ...
  s.currentTime = function (a) {
    return a !== b
      ? (T(this, "setCurrentTime", a), this)
      : (this.F.currentTime = S(this, "currentTime") || 0);
  };
    ...
    a
      ? (t.c(
          ...
          t.bind(this, function (c) {
            ...
            this.isFullscreen() === l &&
              t.k(document, a.fullscreenchange, arguments.callee);
            this.l("fullscreenchange");
          })
        ),
        this.b[a.requestFullscreen]())
      : this.o.Ha()
      ? T(this, "enterFullScreen")
      : (this.yc(), this.l("fullscreenchange"));
    return this;
  };
  s.requestFullScreen = function () {
    t.log.warn(
  ...
  s.exitFullscreen = function () {
    ...
    if (a) document[a.exitFullscreen]();
      ...
      this.o.Ha()
        ...
        : (this.Db(), this.l("fullscreenchange"));
    return this;
  };
  ...
  s.Ac = function (a) {
    27 === a.keyCode &&
      (this.isFullscreen() === f ? this.exitFullscreen() : this.Db());
  };
  s.Db = function () {
    this.Od = l;
  ...
  s.src = function (a) {
    ...
    t.h.isArray(a)
      ...
      ? this.src({ src: a })
      : a instanceof Object &&
        (a.type && !window.videojs[this.Ia].canPlaySource(a)
          ? U(this, [a])
          : ((this.F.src = a.src),
            (this.uc = a.type || ""),
            this.H(function () {
              window.videojs[this.Ia].prototype.hasOwnProperty("setSource")
                ? T(this, "setSource", a)
                : T(this, "src", a.src);
  ...
  s.Ga = function (a) {
    return a !== b
      ? (T(this, "setPreload", a), (this.m.preload = a), this)
      : S(this, "preload");
  };
  s.autoplay = function (a) {
    return a !== b
      ? (T(this, "setAutoplay", a), (this.m.autoplay = a), this)
      : S(this, "autoplay");
  };
  s.loop = function (a) {
    return a !== b
      ? (T(this, "setLoop", a), (this.m.loop = a), this)
      : S(this, "loop");
  };
  s.poster = function (a) {
        ...
        this.yb !== a &&
          ((this.yb = a)
            ? (this.r("vjs-controls-disabled"),
              this.n("vjs-controls-enabled"),
              this.l("controlsenabled"))
            : (this.r("vjs-controls-enabled"),
              this.n("vjs-controls-disabled"),
              this.l("controlsdisabled"))),
        this)
      : this.yb;
  };
  ...
  s.error = function (a) {
    ...
    this.n("vjs-error");
    t.log.error(
      "(CODE:" + this.da.code + " " + t.D.Wa[this.da.code] + ")",
      this.da.message,
      this.da
    );
    return this;
  ...
  s.playbackRate = function (a) {
    return a !== b
      ? (T(this, "setPlaybackRate", a), this)
      : this.o && this.o.featuresPlaybackRate
      ? S(this, "playbackRate")
      : 1;
  };
  s.Ec = l;
  ...
  t.Oa.prototype.s = function () {
    this.d.isFullscreen()
      ? (this.d.exitFullscreen(), (this.xb.innerHTML = this.t("Fullscreen")))
  ...
  t.qb.prototype.m = { children: { seekBar: {} } };
  ...
  t.tb = t.a.extend({
    i: function (a, c) {
      ...
      this.c(a, "loadstart", function () {
        a.o.featuresVolumeControl === l
          ? this.n("vjs-hidden")
          : this.r("vjs-hidden");
      });
    },
  });
  t.tb.prototype.m = { children: { volumeBar: {} } };
  ...
  t.ka.prototype.update = function () {
    ...
    0 === a || this.d.muted()
      ...
      : 0.67 > a && (c = 2);
    this.d.muted()
      ? this.b.children[0].children[0].innerHTML != this.t("Unmute") &&
        (this.b.children[0].children[0].innerHTML = this.t("Unmute"))
      : this.b.children[0].children[0].innerHTML != this.t("Mute") &&
        (this.b.children[0].children[0].innerHTML = this.t("Mute"));
  ...
  s.za = function () {
    ...
    if (c)
      for (var d = c.length - 1; 0 <= d; d--)
        a.U(new t.pb(this.j(), { rate: c[d] + "x" }));
    return a;
  };
  s.sa = function () {
  ...
  function ea(a) {
    return (
      a.j().o &&
      a.j().o.featuresPlaybackRate &&
      a.j().options().playbackRates &&
      0 < a.j().options().playbackRates.length
    );
  }
  s.bd = function () {
  ...
  s.ga = function (a) {
    ...
    this.Eb
      ...
      : ((c = ""),
        a && (c = 'url("' + a + '")'),
        (this.b.style.backgroundImage = c));
  };
  s.s = function () {
    this.d.play();
  };
  ...
  t.q = t.a.extend({
    i: function (a, c, d) {
      ...
      this.featuresProgressEvents ||
        ((this.Ic = f),
        (this.Nc = this.setInterval(function () {
          var a = this.j().bufferedPercent();
          this.vd != a && this.j().l("progress");
          this.vd = a;
          1 === a && this.clearInterval(this.Nc);
        }, 500)));
      this.featuresTimeupdateEvents ||
        ((a = this.d),
        (this.Nb = f),
        this.c(a, "play", this.$c),
        this.c(a, "pause", this.gb),
        this.Q("timeupdate", function () {
  ...
  s.s = function (a) {
    0 === a.button &&
      this.j().controls() &&
      (this.j().paused() ? this.j().play() : this.j().pause());
  };
  s.ce = function () {
  ...
  t.g = t.q.extend({
    i: function (a, c, d) {
      ...
      (c = c.source) &&
        (this.b.currentSrc !== c.src || (a.I && 3 === a.I.Md)) &&
        this.Uc(c);
      ...
      a.H(function () {
        this.I &&
          this.m.autoplay &&
          this.paused() &&
          (delete this.I.poster, this.play());
      });
      this.Ka();
    },
  });
  ...
  s.e = function () {
    ...
    if (!c || this.movingMediaElementInDOM === l)
      c
        ? ((d = c.cloneNode(l)), t.g.Bb(c), (c = d), (a.I = k))
        : ((c = t.e("video")),
          t.Sc(
            c,
            t.h.z(a.se || {}, { id: a.id() + "_html5_api", class: "vjs-tech" })
          )),
        (c.player = a),
        t.Jb(c, a.w());
  ...
  s.Fd = function (a) {
    "error" == a.type && this.error()
      ? this.j().error(this.error().code)
      : ((a.bubbles = l), this.j().l(a));
  };
  s.play = function () {
    this.b.play();
  };
  ...
  s.Ha = function () {
    return "function" == typeof this.b.webkitEnterFullScreen &&
      (/Android/.test(t.N) || !/Chrome|Mac OS X 10.5/.test(t.N))
      ? f
      : l;
  };
  s.xc = function () {
    ...
    "webkitDisplayingFullscreen" in a &&
      this.Q("webkitbeginfullscreen", function () {
  ...
  t.g.Kc = function () {
    4 <= t.Xb &&
      (V || (V = t.A.constructor.prototype.canPlayType),
      ...
      t.jd &&
        this.H(function () {
          this.c("mousemove", function () {
            this.j().l({ type: "mousemove", bubbles: l });
          });
        });
  ...
  t.f.prototype.currentTime = function () {
    return this.seeking()
      ? this.Ud || 0
      : this.b.vjs_getProperty("currentTime");
  };
  ...
  t.f.V.Ta = function (a) {
    return !a.type
      ? ""
      : a.type.replace(/;.*/, "").toLowerCase() in t.f.Id
      ? "maybe"
      : "";
  };
  ...
  function oa(a) {
    0 === a.ra && a.load();
    0 === a.pa &&
      (a.d.c("timeupdate", t.bind(a, a.update, a.K)),
      a.d.c("ended", t.bind(a, a.reset, a.K)),
      ("captions" === a.G || "subtitles" === a.G) &&
        a.d.na("textTrackDisplay").U(a));
  }
  s.vc = function () {
  ...
  s.load = function () {
    0 === this.ra &&
      ...
      t.ye(
        this.Wc,
        t.bind(this, function (a, c, d) {
          if (a) (this.error = a), (this.ra = 3), this.l("error");
          else {
            var e, g;
            a = d.split("\n");
            c = "";
    ...
    if (0 < this.ca.length) {
      ...
      if (this.Qb === b || a < this.Qb || this.$a <= a) {
        var c = this.ca,
          ...
          w;
        a >= this.$a || this.$a === b
          ? (w = this.Fb !== b ? this.Fb : 0)
          : ((g = f), (w = this.Mb !== b ? this.Mb : c.length - 1));
        for (;;) {
          q = c[w];
          if (q.Aa <= a) (e = Math.max(e, q.Aa)), q.Ra && (q.Ra = l);
            ...
            g
              ? (h.splice(0, 0, q), p === b && (p = w), (j = w))
              : (h.push(q), j === b && (j = w), (p = w)),
              (d = Math.min(d, q.Aa)),
  ...
  t.T.prototype.ya = function () {
    var a = [],
      c;
    a.push(new t.ob(this.d, { kind: this.G }));
    for (var d = 0; d < this.d.textTracks().length; d++)
      (c = this.d.textTracks()[d]),
        c.M() === this.G && a.push(new t.aa(this.d, { track: c }));
    return a;
  };
  t.La = t.T.extend({
    i: function (a, c, d) {
  ...
  s.za = function () {
    for (
      var a = this.d.textTracks(), c = 0, d = a.length, e, g, h = (this.P = []);
      c < d;
      c++
    )
      if (((e = a[c]), e.M() == this.G))
    ...
    if (g) {
      ...
      for (var j, c = 0, d = e.length; c < d; c++)
        (j = e[c]),
          (j = new t.ib(this.d, { track: g, cue: j })),
          h.push(j),
          a.U(j);
      this.U(a);
    }
    ...
    t.JSON.parse = function (a, c) {
      function d(a, e) {
        ...
        if (q && "object" === typeof q)
          for (j in q)
            Object.prototype.hasOwnProperty.call(q, j) &&
              ((p = d(q, j)), p !== b ? (q[j] = p) : delete q[j]);
        return c.call(a, e, q);
      }
      var e;
      a = String(a);
    ...
    if (g && 0 < g.length) {
      ...
      for (e = g.length; d < e; d++)
        if ((c = g[d]) && c.getAttribute)
          c.player === b &&
            ((a = c.getAttribute("data-setup")), a !== k && videojs(c));
        else {
          t.wb();
          break;
        }
