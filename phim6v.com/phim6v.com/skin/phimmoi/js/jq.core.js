...
(function(b) {
    b.fn.extend({
        autocomplete: function(a, c) {
            ...
            c = b.extend({}, b.Autocompleter.defaults, {
                url: r ? a : null,
                data: r ? null : a,
    ...
    b.Autocompleter = function(a, c) {
        ...
        function n(a, b) {
            if (w == h.DEL) l.hide();
                ...
                var j = f.val();
                if (b || j != m) m = j, j = g(j), j.length >= c.minChars ? (f.addClass(c.loadingClass), c.matchCase || (j = j.toLowerCase()), e(j, d, p)) : (f.removeClass(c.loadingClass), l.hide())
            }
        }

        function q(a) {
            return !a ? [""] : !c.multiple ? [b.trim(a)] : b.map(a.split(c.multipleSeparator), function(c) {
        ...
        function p() {
            ...
            c.mustMatch && f.search(function(a) {
                a || (c.multiple ? (a = q(f.val()).slice(0, -1), f.val(a.join(c.multipleSeparator) + (a.length ? c.multipleSeparator : ""))) : (f.val(""), f.trigger("result", null)))
            })
        }
        ...
        function d(d, e) {
            if (e && e.length && j) {
                ...
                l.display(e, d);
                var k = e[0].value;
                c.autoFill && (g(f.val()).toLowerCase() == d.toLowerCase() && w != h.BACKSPACE) && (f.val(f.val() + k.substring(g(m).length)), b(a).selection(m.length, m.length + k.length));
                l.show()
            } else p()
        }
        ...
        var h = {
            ...
            t;
        b.browser.opera && b(a.form).bind("submit.autocomplete", function() {
            if (t) return t = !1
        });
        f.bind((b.browser.opera ? "keypress" : "keydown") + ".autocomplete", function(a) {
            j = 1;
            w = a.keyCode;
            switch (a.keyCode) {
                case h.UP:
            ...
            function a(c, e) {
                ...
                "function" == typeof d ? d(j) : f.trigger("result", j && [j.data, j.value])
            }
    ...
    b.Autocompleter.Cache = function(a) {
        function c(d, c) {
            ...
            var b = d.indexOf(c);
            "word" == a.matchContains && (b = d.toLowerCase().search("\\b" + c.toLowerCase()));
            ...
            load: function(d) {
                ...
                if (a.matchSubset)
                    for (h = d.length - 1; h >= a.minChars; h--)
                        if (f = g[d.substr(0, h)]) return e = [], b.each(f, function(a, b) {
    ...
    b.Autocompleter.Select = function(a, c, r, n) {
        ...
        function g(c) {
            ...
            if (a.scroll) {
                ...
                b + c[0].offsetHeight - k.scrollTop() > k[0].clientHeight ? k.scrollTop(b + c[0].offsetHeight - k.innerHeight()) : b < k.scrollTop() && k.scrollTop(b)
            }
        }
        var p = {
        ...
        return {
            display: function(j, g) {
                s && (m = b("<div/>").hide().addClass(a.resultsClass).css("position", "absolute").appendTo(document.body), k = b("<div/>").appendTo(m).mouseover(function(a) {
                    q(a).nodeName && "LI" == q(a).nodeName.toUpperCase() && (e = b("li", k).removeClass(p.ACTIVE).index(q(a)), b(q(a)).addClass(p.ACTIVE))
                }).click(function(a) {
                ...
                }), 0 < a.width && m.css("width", a.width), s = !1);
                h = j;
                f = g;
                k.empty();
                for (var u = a.max && a.max < h.length ? a.max : h.length, l = 0; l < u; l++)
                    if (h[l]) {
                        var t = a.formatItem(h[l].data, l + 1, u, h[l].value, f);
                        !1 !== t && (t = b("<p/>").html(a.highlight(t, f)).addClass("search-item").appendTo(k)[0], b.data(t, "ac_data", h[l]))
                    } d = k.find("li");
            ...
            current: function() {
                return this.visible() && (d.filter("." + p.ACTIVE)[0] || a.selectFirst && d[0])
            },
            show: function() {
                var e = b(c).offset();
                m.css({
                    width: "string" == typeof a.width || 0 < a.width ? a.width : b(c).width(),
                    top: e.top + c.offsetHeight,
                    left: e.left
                }).show();
                if (a.scroll && (k.scrollTop(0), k.css({
                        maxHeight: a.scrollHeight,
                        overflow: "auto"
                    }), b.browser.msie && "undefined" === typeof document.body.style.maxHeight)) {
                    var f = 0;
                    d.each(function() {
                        f += this.offsetHeight
                    });
                    ...
                    e || d.width(k.width() - parseInt(d.css("padding-left")) - parseInt(d.css("padding-right")))
                }
            },
            selected: function() {
    ...
    b.fn.selection = function(a, c) {
        if (void 0 !== a) return this.each(function() {
            if (this.createTextRange) {
                ...
                void 0 === c || a == c ? b.move("character", a) : (b.collapse(!0), b.moveStart("character", a), b.moveEnd("character", c));
                b.select()
        ...
        if (void 0 !== b.selectionStart) return {
