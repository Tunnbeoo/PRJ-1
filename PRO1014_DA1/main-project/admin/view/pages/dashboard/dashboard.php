...
?>
                ...
                <div class="card radius-10 w-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <h6 class="mb-0">Doanh thu theo tháng (Năm <span class="report-year-selected">2024</span> )
                            </h6>
                            <div class="fs-5 ms-auto dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item change-year-sale-report" data-year="2024"
                                            href="javascript:changeYearSaleReport()">Năm
                                            2024</a></li>
                                    <li><a class="dropdown-item change-year-sale-report" data-year="2025"
                                            href="javascript:changeYearSaleReport()">Năm
                                            2025</a></li>
                                </ul>
                            </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <h6 class="mb-0">Doanh thu theo tuần (Năm <span class="report-year-selected">2024</span> )
                    </h6>
                    <div class="fs-5 ms-auto dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item change-year-sale-report" data-year="2024" href="#">Năm
                                    2024</a></li>
                            <li><a class="dropdown-item change-year-sale-report" data-year="2025" href="#">Năm
                                    2025</a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <h6 class="mb-0">Doanh thu theo ngày (Tháng <span class="report-month-selected">3</span>/Năm <span
                            class="report-year-selected">2024</span> )
                    </h6>
                    <div class="fs-5 ms-auto dropdown">
                        <div class="dropdown-toggle dropdown-toggle-nocaret cursor-pointer" data-bs-toggle="dropdown"><i
                                class="bi bi-three-dots"></i></div>
