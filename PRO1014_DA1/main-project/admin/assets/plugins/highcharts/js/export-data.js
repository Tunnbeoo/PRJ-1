    ...
    function (a, d, e, c, g) {
      function u(a, d) {
        ...
        try {
          ...
          if (!f)
            return c.createObjectURL(new p.Blob(["\ufeff" + a], { type: d }));
        } catch (M) {}
      }
      var v = e.doc,
        f = e.seriesTypes,
      ...
      d.prototype.getDataRows = function (b) {
        ...
        var A = t.categoryHeader,
          ...
          G = function (l, d, f) {
            ...
            return l
              ? l instanceof a
                ? (l.options.title && l.options.title.text) ||
                  (l.dateTime ? x : A)
                : b
                ? {
          ...
          g.forEach(function (a) {
            ...
            B &&
              ...
              (B.dateTime
                ...
                : (b = B.categories
                    ? w(B.names[a.x], B.categories[a.x], a.x)
                    : a.x));
            a.splice(v, 0, b);
          });
        }
        ...
        F(
          u(a, "application/vnd.ms-excel") ||
            "data:application/vnd.ms-excel;base64," +
              p.btoa(unescape(encodeURIComponent(a))),
      ...
      d.prototype.toggleDataTable = function () {
        var a,
          ...
          d =
            null === (a = null === n || void 0 === n ? void 0 : n.buttons) ||
            void 0 === a
              ? void 0
        ...
        (null === n || void 0 === n ? 0 : n.menuItemDefinitions) &&
          ...
          c &&
          c.length &&
          (c[d.indexOf("viewData")].innerHTML = this.isDataTableVisible
            ? a.hideData
            : a.viewData);
      };
      var n = K().exporting;
