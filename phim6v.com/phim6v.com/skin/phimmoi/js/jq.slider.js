(function(z) {
    z.fn.carousel = function(a) {
        ...
        return this.each(function() {
            ...
            b.$elts.content = z(this).children().css({
                position: "absolute",
                top: 0
            });
            ...
            b.steps = {
                first: 0,
                count: b.$elts.content.children().length
            };
    ...
    function D(b) {
        ...
        if (b.params.direction == "vertical") {
            b.$elts.content.css({
                height: b.itemHeight * b.steps.count + "px"
            });
            b.$elts.content.parent().css({
                height: b.itemHeight * b.params.dispItems + "px"
            })
        } else {
            b.$elts.content.parent().css({
    ...
    function u(b, a) {
        switch (b.params.effect) {
            ...
            default:
                if (b.params.direction == "vertical") {
                    b.$elts.content.stop().animate({
                        top: -(b.itemHeight * a) + "px"
                    }, b.params.animSpeed, b.params.slideEasing)
                } else {
                    b.$elts.content.stop().animate({
