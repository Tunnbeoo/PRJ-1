...
(function () {
  ...
  if (!a.editor) {
    ...
    a.editor.replace = function (b, c) {
      ...
      if (typeof d != "object") {
        ...
        if (!d)
          throw (
            '[CKEDITOR.editor.replace] The element with id or name "' +
            b +
            '" was not found.'
          );
      }
    ...
    a.editor.appendTo = function (b, c, d) {
      ...
      if (typeof e != "object") {
        ...
        if (!e)
          throw (
            '[CKEDITOR.editor.appendTo] The element with id "' +
            b +
            '" was not found.'
          );
      }
  ...
  if (!a.env)
    a.env = (function () {
      ...
      if (d.ie) {
        ...
        d.ie7Compat =
          (e == 7 && !document.documentMode) || document.documentMode == 7;
      ...
      if (d.ie) {
        d.cssClass +=
          " cke_browser_ie" +
          (d.version < 7 ? "6" : d.version >= 8 ? document.documentMode : "7");
    ...
    a.tools = {
      ...
      cssStyleToDomStyle: (function () {
        var f = document.createElement("div").style,
          g =
            typeof f.cssFloat != "undefined"
              ? "cssFloat"
              : typeof f.styleFloat != "undefined"
              ? "styleFloat"
              : "float";
        return function (h) {
          if (h == "float") return g;
  ...
  a.dtd = (function () {
    var f = e.extend,
      g = { isindex: 1, fieldset: 1 },
      h = { input: 1, button: 1, select: 1, textarea: 1, label: 1 },
      i = f({ a: 1 }, h),
      j = f({ iframe: 1 }, i),
      k = {
        hr: 1,
      ...
      l = { ins: 1, del: 1, script: 1, style: 1 },
      m = f(
        {
          b: 1,
          acronym: 1,
      ...
      w = { li: 1 },
      x = { style: 1, script: 1 },
      y = { base: 1, link: 1, meta: 1, title: 1 },
      z = f(y, x),
      A = { head: 1, body: 1 },
      B = { html: 1 },
      C = {
  ...
  (function (g) {
    ...
    g.getUniqueId = function () {
      return (
        ...
        (this.$["data-cke-expando"] = e.getNextNumber())
      );
    };
  ...
  e.extend(d.node.prototype, {
    ...
    getIndex: function (h) {
      ...
      while ((i = i.previousSibling)) {
        if (
          ...
          i.nodeType == 3 &&
          (!i.nodeValue.length ||
            (i.previousSibling && i.previousSibling.nodeType == 3))
        )
          continue;
        j++;
      }
    ...
    getPosition: function (h) {
      ...
      if (this.type == 1 && h.type == 1) {
        ...
        if ("sourceIndex" in i)
          return i.sourceIndex < 0 || j.sourceIndex < 0
            ? 1
            : i.sourceIndex < j.sourceIndex
            ? 4
            : 2;
      }
  ...
  h.setMarker = function (i, j, k, l) {
    var m =
        j.getCustomData("list_marker_id") ||
        j
          .setCustomData("list_marker_id", e.getNextNumber())
          .getCustomData("list_marker_id"),
      n =
        j.getCustomData("list_marker_names") ||
        j
  ...
  e.extend(h.prototype, {
    ...
    appendBogus: function () {
      ...
      if (!i || !i.is || !i.is("br")) {
        var j = b.opera
          ? k.getDocument().createText("")
          : k.getDocument().createElement("br");
      ...
      if (c && (b.ie7Compat || b.ie6Compat))
        return function (j) {
          ...
          switch (j) {
            ...
            case "contentEditable":
              return n.$.attributes.getNamedItem("contentEditable").specified
    ...
    isEditable: function (i) {
      ...
      if (
        l.isReadOnly() ||
        l.getComputedStyle("display") == "none" ||
        l.getComputedStyle("visibility") == "hidden" ||
        (l.is("a") && l.data("cke-saved-name") && !l.getChildCount()) ||
        f.$nonEditable[j] ||
        f.$empty[j]
      )
        return false;
    ...
    isIdentical: function (i) {
      ...
      for (var n = 0; n < l; n++) {
        ...
        if (
          (!c || (o.specified && o.nodeName != "data-cke-expando")) &&
          o.nodeValue != i.getAttribute(o.nodeName)
        )
          return false;
      }
      if (c)
        for (n = 0; n < m; n++) {
          ...
          if (
            o.specified &&
            o.nodeName != "data-cke-expando" &&
            o.nodeValue != this.getAttribute(o.nodeName)
          )
            return false;
        }
      return true;
    ...
    isEmptyInlineRemoveable: function () {
      ...
      for (var j = 0, k = i.count(); j < k; j++) {
        ...
        if (
          (l.type == 1 && !l.isEmptyInlineRemoveable()) ||
          (l.type == 3 && e.trim(l.getText()))
        )
          return false;
      }
      return true;
    ...
    hasAttributes:
      c && (b.ie7Compat || b.ie6Compat)
        ...
        : function () {
            var i = this.$.attributes,
              j = i.length,
              k = { "data-cke-expando": 1, _moz_dirty: 1 };
            return (
              j > 0 &&
              (j > 2 || !k[i[0].nodeName] || (j == 2 && !k[i[1].nodeName]))
            );
          },
    ...
    removeStyle: function (i) {
      ...
      j.removeProperty
        ? j.removeProperty(i)
        : j.removeAttribute(e.cssStyleToDomStyle(i));
    ...
    scrollIntoView: function (i) {
      ...
      do {
        var k =
          (j.$.clientWidth && j.$.clientWidth < j.$.scrollWidth) ||
          (j.$.clientHeight && j.$.clientHeight < j.$.scrollHeight);
    ...
    getDirection: function (i) {
      var j = this;
      return i
        ? j.getComputedStyle("direction") ||
            j.getDirection() ||
            j.getDocument().$.dir ||
            j.getDocument().getBody().getDirection(1)
        : j.getStyle("direction") || j.getAttribute("dir");
    },
    data: function (i, j) {
      i = "data-" + i;
  ...
  (function () {
    ...
    h.prototype.getSize = function (k, l) {
      var m =
        Math.max(
          this.$["offset" + e.capitalize(k)],
          this.$["client" + e.capitalize(k)]
        ) || 0;
  ...
  a.command.prototype = {
    enable: function () {
      ...
      if (i.state == 0)
        i.setState(
          !i.preserveState || typeof i.previousState == "undefined"
            ? 2
            : i.previousState
        );
    },
  ...
  a.resourceManager.prototype = {
    add: function (j, k) {
      ...
      a.fire(
        j + e.capitalize(this.fileName) + "Ready",
        (this.registered[j] = k || {})
      );
    },
    get: function (j) {
    ...
    getFilePath: function (j) {
      ...
      return a.getUrl(
        this.getPath(j) +
          (k && typeof k.file == "string" ? k.file : this.fileName + ".js")
      );
    },
  ...
  (function () {
    var l = 0,
      ...
      q = function (x) {
        ...
        x.tabIndex =
          x.config.tabIndex || x.element.getAttribute("tabindex") || 0;
        x.readOnly = !!(
          x.config.readOnly || x.element.getAttribute("disabled")
        );
      ...
      r = function (x) {
        a.lang.load(
          ...
          function (y, z) {
            ...
            x.fire("langLoaded");
            var A = x.config;
            A.contentsLangDirection == "ui" &&
              (A.contentsLangDirection = x.lang.dir);
            s(x);
          }
        );
      },
    ...
    a.editor.prototype._init = function () {
      ...
      z.element = x;
      z.name =
        (x && z.elementMode == 1 && (x.getId() || x.getNameAtt())) || m();
  ...
  e.extend(a.editor.prototype, {
    ...
    execCommand: function (l, m) {
      var n = this.getCommand(l),
        o = { name: l, commandData: m, command: n };
      if (n && n.state != 0)
  ...
  (function () {
    var l = e.extend(
      ...
      m = c && b.version < 8 ? { dd: 1, dt: 1 } : {},
      n = { ol: 1, ul: 1 },
      o = e.extend({}, { html: 1 }, f.html, f.body, f.head, {
        style: 1,
        script: 1,
      });
    function p(q) {
  ...
  a.htmlParser.cssStyle = function () {
    ...
    return {
      ...
      populate: function (o) {
        ...
        if (p)
          o instanceof h
            ? o.setAttribute("style", p)
            : o instanceof a.htmlParser.element
            ? (o.attributes.style = p)
            : (o.style = p);
      },
      toString: function () {
        var o = [];
  ...
  (function () {
    ...
    a.htmlParser.element.prototype = {
      ...
      writeHtml: function (m, n) {
        ...
        p.filterChildren = function () {
          if (!u) {
            ...
            p.children = new a.htmlParser.fragment.fromHtml(
              B.getHtml(),
              0,
              p.clone()
            ).children;
      ...
      writeChildrenHtml: function (m, n) {
        a.htmlParser.fragment.prototype.writeChildrenHtml.apply(
          this,
          arguments
        );
      },
      ...
      proto: {
        ...
        onNode: function (q) {
          ...
          return r == 1
            ? this.onElement(q)
            : r == 3
            ? new a.htmlParser.text(this.onText(q.value))
            : r == 8
            ? new a.htmlParser.comment(this.onComment(q.value))
            : null;
        },
  ...
  (function () {
          ...
          if (v.type == 1)
            if (z > 0) v = v.getChild(z - 1);
              ...
              v =
                A(v, true) === false
                  ? null
                  : v.getPreviousSourceNode(true, C, A);
        } else {
          v = w;
          if (v.type == 1)
            if (!(v = v.getChild(y)))
    ...
    h.prototype.isBlockBoundary = function (s) {
      ...
      return (
        (this.getComputedStyle("float") == "none" &&
          n[this.getComputedStyle("display")]) ||
        t[this.getName()]
      );
    };
    ...
    d.walker.bookmark = function (s, t) {
      function u(v) {
        return (
          v && v.getName && v.getName() == "span" && v.data("cke-bookmark")
        );
      }
      return function (v) {
        var w, x;
      ...
      return function (u) {
        ...
        if (v) {
          var w = u.getParent(),
            x = u.getNext(t);
          v =
            w.isBlockBoundary() && (!x || (x.type == 1 && x.isBlockBoundary()));
        }
        return !!(s ^ v);
      };
    };
    var o = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/,
      ...
      r = function (s) {
        return (
          ...
          p(s) ||
          (s.type == 1 &&
            s.getName() in f.$inline &&
            !(s.getName() in f.$empty))
        );
      };
  ...
  (function () {
    var l = function (u) {
        u.collapsed =
          u.startContainer &&
          u.endContainer &&
          u.startContainer.equals(u.endContainer) &&
      ...
      m = function (u, v, w, x) {
        ...
        if (v == 2) {
          ...
          if (
            H &&
            I &&
            (y.$.parentNode != H.$.parentNode ||
              z.$.parentNode != I.$.parentNode)
          ) {
            var S = I.getIndex();
            if (C && I.$.parentNode == y.$.parentNode) S--;
            if (x && H.type == 1) {
              var T = h.createFromHtml(
    ...
    function q(u) {
      return function (v) {
        return (
          (!u && p(v)) ||
          (v.type == 3
            ? !e.trim(v.getText()) || !!v.getParent().data("cke-bookmark")
            : v.getName() in f.$removeEmpty)
        );
      };
    }
        ...
        switch (u) {
          ...
          case 3:
            ...
            var N = new d.walker(M),
              O,
              P,
              Q = d.walker.blockBoundary(u == 3 ? { br: 1 } : null),
              R = function (X) {
                var Y = Q(X);
                if (!Y) O = X;
                return Y;
            ...
            this.setStartAt(
              O,
              !O.is("br") &&
                ((!A && this.checkStartOfBlock()) || (A && O.contains(A)))
                ? 1
                : 4
            );
            if (u == 3) {
            ...
            this.setEndAt(
              O,
              (!A && this.checkEndOfBlock()) || (A && O.contains(A)) ? 2 : 3
            );
      ...
      checkReadOnly: (function () {
        function u(v, w) {
          while (v) {
            if (v.type == 1)
              if (
                v.getAttribute("contentEditable") == "false" &&
                !v.data("cke-editable")
              )
                return 0;
              else if (
                v.is("html") ||
                (v.getAttribute("contentEditable") == "true" &&
                  (v.contains(w) || v.equals(w)))
              )
                break;
            v = v.getParent();
          }
  ...
  (function () {
    ...
    function m(n, o, p) {
      ...
      if (r.equals(t.getPrevious())) {
        o.startOffset =
          o.startOffset - r.getLength() - u.getPrevious().getLength();
        r = u.getNext();
  ...
  (function () {
    ...
    try {
      b.hc =
        l.getComputedStyle("border-top-color") ==
        l.getComputedStyle("border-right-color");
    } catch (m) {
      b.hc = false;
    }
          ...
          e.extend(n, {
            ...
            setUiColor: function (v) {
              var w,
                ...
                z = [
                  y + " .cke_wrapper",
                  y + "_dialog .cke_dialog_contents",
                  y + "_dialog a.cke_dialog_tab",
                  y + "_dialog .cke_dialog_footer",
                ].join(","),
  ...
  (function () {
    var m = { table: 1, ul: 1, ol: 1, blockquote: 1, div: 1 },
      n = {},
      o = {};
    ...
    function q(B) {
      ...
      if (!F) return;
      var H = E
        ? F.getComputedStyle("direction")
        : F.getStyle("direction") || F.getAttribute("dir");
    ...
    function r(B) {
      ...
      C.fire(
        "contentDirChanged",
        D ? D.getComputedStyle("direction") : C.lang.dir
      );
    }
    function s(B) {
    ...
    function t(B, C, D, E) {
      ...
      var G = "useComputedState" in D.config ? D.config.useComputedState : 1,
        H = G
          ? B.getComputedStyle("direction")
          : B.getStyle("direction") || B.hasAttribute("dir");
      if (H == C) return;
      B.removeStyle("direction");
      if (G) {
        B.removeAttribute("dir");
            ...
            O.evaluator = function (R) {
              return !!(
                ...
                !(
                  R.getName() == (E == 1 ? "p" : "div") &&
                  R.getParent().type == 1 &&
                  R.getParent().getName() == "blockquote"
                ) &&
                R.getPosition(P) & 2 &&
                (R.getPosition(Q) & (4 + 16)) == 4
              );
            };
    ...
    var p = {
      exec: function (q) {
        ...
        if (r == 2) {
          ...
          if (A.length < 1) {
            var B = q.document.createElement(
                q.config.enterMode == 1 ? "p" : "div"
              ),
              C = u.shift();
            t.insertNode(B);
            ...
            while (O.length) {
              ...
              if (Q.getName() == "div") {
                ...
                var S =
                  ...
                  Q.getPrevious() &&
                  !(
                    Q.getPrevious().type == 1 &&
                    Q.getPrevious().isBlockBoundary()
                  );
                if (S) I.append(q.document.createElement("br"));
                var T =
                  Q.getNext() &&
                  !(Q.getNext().type == 1 && Q.getNext().isBlockBoundary());
      ...
      render: function (m, n) {
        ...
        if (this.modes) {
          ...
          if (r) {
            ...
            q +=
              "cke_" +
              (r.state == 1 ? "on" : r.state == 0 ? "disabled" : "off");
          }
        }
        if (!r) q += "cke_off";
        ...
        n.push(
          '<span class="cke_button' +
            (this.icon && this.icon.indexOf(".png") == -1
              ? " cke_noalphafix"
              : "") +
            '">',
          '<a id="',
        ...
        n.push(
          ' onkeydown="return CKEDITOR.tools.callFunction(',
          u,
          ', event);" onfocus="return CKEDITOR.tools.callFunction(',
          v,
          ', event);" ' +
            (c ? 'onclick="return false;" onmouseup' : "onclick") +
  ...
  (function () {
    ...
    var p = {
        ...
        exec: c
          ...
          : function (y) {
              try {
                if (
                  !y.document.getBody().fire("beforepaste") &&
                  !y.document.$.execCommand("Paste", false, null)
                )
                  throw 0;
              } catch (z) {
                setTimeout(function () {
    ...
    function s(y, z, A) {
      ...
      F.setStyle(
        this.config.contentsLangDirection == "ltr" ? "left" : "right",
        "-1000px"
      );
        ...
        y.on("contentDom", function () {
          ...
          A.on(!c ? "paste" : "beforepaste", function (B) {
            ...
            s.call(y, B, D.mode, function (E) {
              if (
                !(E = e.trim(
                  E.replace(/<span[^>]+data-cke-bookmark[^<]*?<\/span>/gi, "")
                ))
              )
                return;
              var F = {};
      ...
      function q(t, u, v) {
        ...
        m.ui.add(t, "panelbutton", {
          ...
          panel: {
            ...
            attributes: { role: "listbox", "aria-label": o.panelTitle },
          },
            ...
            if (E) {
              ...
              I.childRule =
                F == "back"
                  ...
                  : function (J) {
                      return (
                        !(J.is("a") || J.getElementsByTag("a").count()) || s(J)
                      );
                    };
          ...
          v = e.addFunction(function (x, y) {
            ...
            switch (y.getKeystroke()) {
              ...
              case 2228224 + 9:
                A = a.document.getById(z + (x - 1));
                if (!A)
                  A = a.document.getById(
                    z + (o._.elementsPath.list.length - 1)
                  );
                A.focus();
                return false;
              case 27:
          ...
          while (A) {
            ...
            if (!F) {
              ...
              B.unshift(
                ...
                J,
                ', event );"' + K,
                ' onclick="CKEDITOR.tools.callFunction(' + u,
                ",",
                J,
                '); return false;"',
                ' role="button" aria-labelledby="' + s + J + '_label">',
                G,
                '<span id="',
                s,
                J,
                '_label" class="cke_label">' + L + "</span>",
                "</a>"
              );
            }
            if (G == "body") break;
    ...
    j.enterkey = {
      enterBlock: function (t, u, v, w) {
        ...
        if (!G && !H) {
          if (
            F.is("li") &&
            (I = F.getFirst(d.walker.invisible(true))) &&
            I.is &&
            I.is("ul", "ol")
          )
    ...
    j.add("entities", {
      afterInit: function (r) {
        ...
        if (u) {
          ...
          x = new RegExp(x, "g");
          function y(C) {
            return s.entities_processNumerical == "force" || !w[C]
              ? "&#" + C.charCodeAt(0) + ";"
              : w[C];
          }
  ...
  (function () {
    ...
    function o(v) {
      ...
      x._.filebrowserSe = C;
      var y =
          x.config["filebrowser" + n(w.getName()) + "WindowWidth"] ||
          x.config.filebrowserWindowWidth ||
          "80%",
        z =
          x.config["filebrowser" + n(w.getName()) + "WindowHeight"] ||
          x.config.filebrowserWindowHeight ||
          "70%",
      ...
      x.popup(
        ...
        y,
        z,
        x.config.filebrowserWindowFeatures || x.config.fileBrowserWindowFeatures
      );
    }
    function p(v) {
      var y = this;
      ...
      x._.filebrowserSe = y;
      if (
        !w.getContentElement(y["for"][0], y["for"][1]).getInputElement().$.value
      )
        return false;
        ...
        if (p.contextMenu)
          p.contextMenu.addListener(function (q, r) {
            if (
              ...
              q.is("img") &&
              !q.isReadOnly() &&
              q.data("cke-real-element-type") == "flash"
            )
              return { flash: 2 };
          });
      },
    ...
    init: function (m) {
      ...
      m.on("doubleclick", function (q) {
        ...
        if (r.is("form")) q.data.dialog = "form";
          ...
          r.is("img") &&
          r.data("cke-real-element-type") == "hiddenfield"
        )
          ...
          elements: {
            input: function (q) {
              if (q.attributes.type == "hidden")
                return m.createFakeParserElement(
                  q,
                  "cke_hidden",
                  "hiddenfield"
                );
  ...
  if (c)
    h.prototype.hasAttribute = e.override(
      h.prototype.hasAttribute,
      function (m) {
        return function (n) {
          var q = this;
  ...
  (function () {
    ...
    function q(T, U, V) {
      ...
      if (
        U &&
        c &&
        (document.documentMode > 7 || T.name in f.tr || T.name in f.$listItem)
      )
        return false;
      var W = o(T);
      return (
    ...
    delete u.pre;
    var w = { elements: {}, attributeNames: [[/^on/, "data-cke-pa-on"]] },
      x = { elements: {} };
    ...
    var y = {
      ...
      elements: {
        ...
        table: function (T) {
          var U = T.children;
          U.sort(function (V, W) {
            return V.type == 1 && W.type == V.type
              ? e.indexOf(t, V.name) > e.indexOf(t, W.name)
                ? 1
                : -1
              : 0;
          });
        ...
        a: function (T) {
          if (
            !(
              T.children.length ||
              T.attributes.name ||
              T.attributes["data-cke-saved-name"]
            )
          )
            return false;
        },
    ...
    function P(T) {
      return T.replace(/<!--(?!{cke_protected})[\s\S]+?-->/g, function (U) {
        return (
          ...
          n +
          "{C}" +
          encodeURIComponent(U).replace(/--/g, "%2D%2D") +
          "-->"
        );
      });
    }
    ...
    function S(T, U) {
      var V = [],
        ...
        X = U._.dataStore || (U._.dataStore = { id: 1 }),
      ...
      for (var aa = 0; aa < Z.length; aa++)
        T = T.replace(Z[aa], function (ab) {
          ...
          return /cke_temp(comment)?/.test(ab)
            ? ab
            : "<!--{cke_temp}" + (V.push(ab) - 1) + "-->";
        });
      T = T.replace(Y, function (ab, ac, ad) {
        return (
          ...
          n +
          (ac ? "{C}" : "") +
          encodeURIComponent(V[ad]).replace(/--/g, "%2D%2D") +
          "-->"
        );
      });
  ...
  (function () {
    j.add("iframe", {
      ...
      init: function (m) {
        ...
        if (m.addMenuItems)
          m.addMenuItems({
            iframe: { label: o.title, command: "iframe", group: "image" },
          });
        if (m.contextMenu)
  ...
  (function () {
    ...
    function p(t) {
      ...
      if (B.useIndentClasses) {
        ...
        if (
          (B.name == "outdent" && !z) ||
          (B.name == "indent" && z == u.config.indentClasses.length)
        )
          return B.setState(0);
        return B.setState(2);
      } else {
    ...
    function q(t, u) {
      ...
      w.name = u;
      w.useIndentClasses =
        t.config.indentClasses && t.config.indentClasses.length > 0;
      if (w.useIndentClasses) {
        w.classNameRegex = new RegExp(
          "(?:^|\\s+)(" + t.config.indentClasses.join("|") + ")(?=$|\\s)"
        );
        w.indentClassMap = {};
    ...
    function r(t, u) {
      return (u || t.getComputedStyle("direction")) == "ltr"
        ? "margin-left"
        : "margin-right";
    }
    function s(t) {
    ...
    q.prototype = {
      exec: function (t) {
        ...
        function w(M) {
          ...
          for (
            T = V.getCustomData("listarray_index");
          ...
          for (
            T = W.getCustomData("listarray_index") + 1;
            T < X.length && X[T].indent > Y;
            T++
          )
            X[T].indent += U;
          var aa = j.list.arrayToList(
            X,
            v,
            null,
            t.config.enterMode,
        ...
        function y(M, N) {
          ...
          if (u.useIndentClasses) {
            ...
            P = Math.max(P, 0);
            M.$.className = e.ltrim(
              M.$.className.replace(u.classNameRegex, "")
            );
        ...
        while ((C = D.getNextRange())) {
          ...
          if (
            F &&
            C.startContainer.type == 1 &&
            C.startContainer.getName() in m
          ) {
          ...
          if (F) {
            ...
            if (
              !(
                ...
                (u.name == "indent" ||
                  u.useIndentClasses ||
                  parseInt(F.getStyle(r(F)), 10)) &&
                y(F, !J && I.getDirection())
              )
            )
              w(F);
          } else x();
  ...
  (function () {
    function m(q, r) {
      ...
      if (r) s = q.getComputedStyle("text-align");
        ...
        while (
          !q.hasAttribute ||
          !(q.hasAttribute("align") || q.getStyle("text-align"))
        ) {
          var t = q.getParent();
          if (!t) break;
          q = t;
      ...
      !s &&
        r &&
        (s = q.getComputedStyle("direction") == "rtl" ? "right" : "left");
      return s;
    }
    function n(q) {
    ...
    o.prototype = {
        ...
        for (var z = u.length - 1; z >= 0; z--) {
          ...
          while ((x = w.getNextParagraph(s == 1 ? "p" : "div"))) {
            ...
            var A =
                v &&
                (x.$.className = e.ltrim(
                  x.$.className.replace(C.cssClassRegex, "")
                )),
      ...
      refresh: function (q) {
        ...
        this.setState(
          r.getName() != "body" &&
            m(r, this.editor.config.useComputedState) == this.value
            ? 1
            : 2
        );
      },
  ...
  j.add("link", {
    ...
    init: function (m) {
      ...
      var n = m.lang.dir == "rtl" ? "right" : "left",
        o =
          "background:url(" +
          a.getUrl(this.path + "images/anchor.gif") +
          ") no-repeat " +
          n +
          " center;" +
      ...
      m.addCss(
        "a.cke_anchor,a.cke_anchor_empty" +
          (c && b.version < 7 ? "" : ",a[name],a[data-cke-saved-name]") +
          "{" +
          o +
          "padding-" +
          n +
          ...
          "cursor:auto;" +
          "}" +
          (c ? "a.cke_anchor_empty{display:inline-block;}" : "") +
          "img.cke_anchor" +
          "{" +
          o +
          "width:16px;" +
      ...
      m.on("selectionChange", function (p) {
        ...
        var q = m.getCommand("unlink"),
          r =
            ...
            p.data.path.lastElement.getAscendant("a", true);
        if (
          r &&
          r.getName() == "a" &&
          r.getAttribute("href") &&
      ...
      m.on("doubleclick", function (p) {
        ...
        if (!q.isReadOnly())
          if (q.is("a")) {
            p.data.dialog =
              q.getAttribute("name") &&
              (!q.getAttribute("href") || !q.getChildCount())
                ? "anchor"
                : "link";
    ...
    afterInit: function (m) {
      ...
      if (q)
        q.push(function (r, s) {
          if (s == "a")
            if (
              j.link.tryRestoreFakeAnchor(m, r) ||
              (r.getAttribute("name") &&
                (!r.getAttribute("href") || !r.getChildCount()))
            )
              return "anchor";
        });
    },
  ...
  j.link = {
    ...
    tryRestoreFakeAnchor: function (m, n) {
      if (
        n &&
        n.data("cke-real-element-type") &&
        n.data("cke-real-element-type") == "anchor"
      ) {
  ...
  a.removeAnchorCommand.prototype = {
    exec: function (m) {
      ...
      if (
        n &&
        (p = n.getSelectedElement()) &&
        (j.link.fakeAnchor && !p.getChildCount()
          ? j.link.tryRestoreFakeAnchor(m, p)
          : p.is("a"))
      )
        p.remove(1);
  ...
  (function () {
    ...
    function t(N, O) {
      ...
      P &&
        O.setAttribute(
          "style",
          P.replace(/([^;])$/, "$1;") + (O.getAttribute("style") || "")
        );
    }
    j.list = {
          ...
          if (ac.indent == X) {
            ...
            if (Y.type == 11 && W != N.length - 1) {
              ...
              if (an && an.type == 1 && an.getAttribute("type") == "_moz")
                an.remove();
              if (
                !(an = Y.getLast(q) && an.type == 1 && an.getName() in f.$block)
              )
    ...
    function y(N, O, P) {
      ...
      var Y = j.list.arrayToList(
          Q,
          P,
          null,
          N.config.enterMode,
          O.root.getAttribute("dir")
        ),
        Z = Y.listNode,
        aa,
        ab;
      function ac(ad) {
        if (
          (aa = Z[ad ? "getFirst" : "getLast"]()) &&
          !(aa.is && aa.isBlockBoundary()) &&
          (ab = O.root[ad ? "getPrevious" : "getNext"](
            d.walker.whitespaces(true)
          )) &&
          !(ab.is && ab.isBlockBoundary({ br: 1 }))
        )
          N.document
            .createElement("br")
            [ad ? "insertBefore" : "insertAfter"](aa);
      }
      ac(true);
      ac();
      Z.replace(O.root);
      ...
      exec: function (N) {
        ...
        if (aq.state == 2) {
          ...
          if (!S.getFirst(q)) {
            P.enterMode == 2
              ? S.appendBogus()
              : R[0].fixBlock(1, P.enterMode == 1 ? "p" : "div");
            Q.selectRanges(R);
          } else {
    ...
    function G(N) {
      return function (O) {
        ...
        if (
          S &&
          ((S.name && S.name == "br") || (S.value && (T = S.value.match(E))))
        ) {
          var U = S;
          if (!(T && T.index) && U == P[0])
            P[0] =
              N || c
                ? new a.htmlParser.text("\xa0")
                : new a.htmlParser.element("br", {});
    ...
    function K(N) {
      return (
        N.type == 1 &&
        (N.getName() in f.$block || N.getName() in f.$listItem) &&
        f[N.getName()]["#"]
      );
    }
    function L(N, O, P) {
        ...
        N.on("key", function (Q) {
          ...
          if (N.mode == "wysiwyg" && R in { 8: 1, 46: 1 }) {
            ...
            if (U) {
              var Y,
                Z,
                aa = new d.elementPath(T.startContainer);
              if (
                (Y = aa.contains(m)) &&
                T.checkBoundaryOfElement(Y, 1) &&
                (Y = Y.getParent()) &&
                Y.is("li") &&
                (Y = M(Y))
              ) {
  ...
  (function () {
    j.liststyle = {
      ...
      init: function (m) {
        m.addCommand(
          "numberedListStyle",
          new a.dialogCommand("numberedListStyle")
        );
        a.dialog.add("numberedListStyle", this.path + "dialogs/liststyle.js");
        m.addCommand(
          "bulletedListStyle",
          new a.dialogCommand("bulletedListStyle")
        );
  ...
  (function () {
    ...
    function r(s) {
      ...
      var t = h.createFromHtml(
        '<iframe frameborder="0" tabindex="-1" src="javascript:void((function(){document.open();' +
          (b.isCustomDomain()
            ? "document.domain='" + this.getDocument().$.domain + "';"
            : "") +
          "document.close();" +
          '})())"' +
        ...
        s.addCommand("maximize", {
          ...
          exec: function () {
            ...
            if (this.state == 2) {
              ...
              C.setStyle(
                "position",
                b.gecko && b.quirks ? "fixed" : "absolute"
              );
              C.$.offsetLeft;
              C.setStyles({
  ...
  j.add("pagebreak", {
    init: function (m) {
      ...
      var n = [
        "{",
        "background: url(" +
          a.getUrl(this.path + "images/pagebreak.gif") +
        ...
        q.addRules(
          {
            attributes: {
              class: function (r, s) {
                ...
                if (t != r) {
                  var u = a.htmlParser.fragment.fromHtml(
        ...
        p.addRules({
          elements: {
            div: function (r) {
              ...
              if (
                v &&
                /page-break-after\s*:\s*always/i.test(t) &&
                /display\s*:\s*none/i.test(v)
              ) {
                s.contenteditable = "false";
    ...
    j.add("pastefromword", {
        ...
        n.on(
          ...
          function (q) {
            ...
            if (
              (s = r.html) &&
              (o ||
                /(class=\"?Mso|style=\"[^\"]*\bmso\-|w:WordDocument)/.test(s))
            ) {
              var t = this.loadFilterRules(function () {
                if (t) n.fire("paste", r);
                else if (
                  !n.config.pasteFromWordPromptCleanup ||
                  o ||
                  confirm(n.lang.pastefromword.confirmCleanup)
                )
      ...
      loadFilterRules: function (n) {
        ...
        if (o) n();
          ...
          var p = a.getUrl(
            i.pasteFromWordCleanupFile || this.path + "filter/default.js"
          );
        ...
        exec: function (p) {
          ...
          if (r.fullPage)
            ...
            q =
              p.config.docType +
              '<html dir="' +
              p.config.contentsLangDirection +
              '">' +
              "<head>" +
              s +
              "<title>" +
              p.lang.preview +
              "</title>" +
              e.buildStyleHtml(p.config.contentsCss) +
              "</head>" +
              u +
              p.getData() +
              "</body></html>";
  ...
  j.removeformat = {
    commands: {
      removeformat: {
        exec: function (m) {
          var n =
              m._.removeFormatRegex ||
              (m._.removeFormatRegex = new RegExp(
                "^(?:" + m.config.removeFormatTags.replace(/,/g, "|") + ")$",
                "i"
              )),
            o =
              m._.removeAttributes ||
              (m._.removeAttributes =
                m.config.removeFormatAttributes.split(",")),
          ...
          while ((s = r.getNextRange())) {
            ...
            if (v) {
              ...
              while (w) {
                ...
                if (
                  !(w.getName() == "img" && w.data("cke-realelement")) &&
                  p(m, w)
                )
    ...
    init: function (m) {
      ...
      if (n.resize_enabled !== false) {
        var p = null,
          ...
          r,
          s =
            (n.resize_dir == "both" || n.resize_dir == "horizontal") &&
            n.resize_minWidth != n.resize_maxWidth,
          t =
            (n.resize_dir == "both" || n.resize_dir == "vertical") &&
            n.resize_minHeight != n.resize_maxHeight;
        function u(x) {
  ...
  (function () {
    ...
    var p = function () {
      ...
      t.on("beforeCommandExec", function (y) {
        if (
          (y.data.name == "source" || y.data.name == "newpage") &&
          t.mode == "wysiwyg"
        ) {
          var z = q.getScayt(t);
          if (z) {
      ...
      t.on("afterCommandExec", function (y) {
        ...
        if (
          t.mode == "wysiwyg" &&
          (y.data.name == "undo" || y.data.name == "redo")
        )
          window.setTimeout(function () {
      ...
      if (w)
        w.addRules({
          elements: {
            span: function (y) {
              if (
                y.attributes["data-scayt_word"] &&
                y.attributes["data-scaytid"]
              ) {
                delete y.name;
                return y;
              }
        ...
        for (var w = 0; w < 4; w++)
          u[w] =
            ...
            typeof window.scayt.uiTags != "undefined"
              ? parseInt(v[w], 10) && window.scayt.uiTags[w]
              : parseInt(v[w], 10);
        return u;
      },
  ...
  (function () {
    var m =
        ".%2 p,.%2 div,.%2 pre,.%2 address,.%2 blockquote,.%2 h1,.%2 h2,.%2 h3,.%2 h4,.%2 h5,.%2 h6{background-repeat: no-repeat;background-position: top %3;border: 1px dotted gray;padding-top: 8px;padding-%3: 8px;}.%2 p{%1p.png);}.%2 div{%1div.png);}.%2 pre{%1pre.png);}.%2 address{%1address.png);}.%2 blockquote{%1blockquote.png);}.%2 h1{%1h1.png);}.%2 h2{%1h2.png);}.%2 h3{%1h3.png);}.%2 h4{%1h4.png);}.%2 h5{%1h5.png);}.%2 h6{%1h6.png);}",
      n = /%1/g,
      o = /%2/g,
      p = /%3/g,
      q = {
      ...
      init: function (r) {
        ...
        r.addCss(
          m
            .replace(
              n,
              "background-image: url(" + a.getUrl(this.path) + "images/block_"
            )
    ...
    j.add("showborders", {
      ...
      init: function (q) {
        ...
        q.on("removeFormatCleanup", function (s) {
          var t = s.data;
          if (
            q.getCommand("showborders").state == 1 &&
            t.is("table") &&
            (!t.hasAttribute("border") ||
              parseInt(t.getAttribute("border"), 10) <= 0)
          )
            t.addClass(m);
        });
      },
  ...
  (function () {
    ...
    function o(G) {
      ...
      while ((K = G[H++])) {
        if (
          ((L = K.getPrevious()) && !L.getCustomData("delete_cell")) ||
          ((L = K.getNext()) && !L.getCustomData("delete_cell"))
        ) {
          h.clearAllMarkers(J);
          return L;
        }
          ...
          for (var T = 0; T < R.length; T++) {
            ...
            if (U.$.rowSpan == 1) U.remove();
              ...
              if (V == Q) {
                var W = K[Q + 1];
                W[T - 1]
                  ? U.insertAfter(new h(W[T - 1]))
                  : new h(J.$.rows[Q + 1]).append(U, 1);
              }
            }
            T += U.$.colSpan - 1;
          }
    ...
    function C(G, H, I) {
      var J = n(G),
        K;
      if (
        (H ? J.length != 1 : J.length < 2) ||
        ((K = G.getCommonAncestor()) && K.type == 1 && K.is("table"))
      )
        return false;
      var L,
        M = J[0],
      ...
      if (H) {
        ...
        try {
          ...
          T =
            O[H == "up" ? R - U : H == "down" ? R + U : R][
              H == "left" ? S - V : H == "right" ? S + V : S
            ];
        } catch (an) {
          return false;
        }
        ...
        if (!I) {
          if ((y(L), L.getChildren().count())) {
            if (
              ah != X &&
              ae &&
              !(ae.isBlockBoundary && ae.isBlockBoundary({ br: 1 }))
            ) {
  ...
  (function () {
    var m = { editorFocus: false, modes: { wysiwyg: 1, source: 1 } },
      n = {
        exec: function (q) {
        ...
        exec: function (r) {
          if (r.focusManager.hasFocus) {
            var s = r.getSelection(),
              ...
              u;
            if (
              (u = t.getAscendant("td", true) || t.getAscendant("th", true))
            ) {
    ...
    j.add("tab", {
      ...
      init: function (q) {
        ...
        if (r)
          q.on("key", function (u) {
            if (
              (u.data.keyCode == 9 && q.execCommand("selectNextCell")) ||
              (u.data.keyCode == 2228224 + 9 &&
                q.execCommand("selectPreviousCell"))
            )
              u.cancel();
          });
        if (b.webkit || b.gecko)
      ...
      init: function (o) {
            ...
            switch (s) {
              ...
              case 2228224 + 9:
                while (!u || !u.items.length) {
                  u =
                    s == 9
                      ? (u ? u.next : r.toolbar.next) || o.toolbox.toolbars[0]
                      : (u ? u.previous : r.toolbar.previous) ||
                        o.toolbox.toolbars[o.toolbox.toolbars.length - 1];
                  if (u.items.length) {
        ...
        o.on("themeSpace", function (r) {
          if (r.data.space == o.config.toolbarLocation) {
            ...
            var s = e.getNextId(),
              t = [
                '<div class="cke_toolbox" role="group" aria-labelledby="',
                s,
            ...
            var w = o.toolbox.toolbars,
              x =
                o.config.toolbar instanceof Array
                  ? o.config.toolbar
                  : o.config["toolbar_" + o.config.toolbar];
            for (var y = 0; y < x.length; y++) {
              var z,
                A = 0,
                B,
            ...
            if (o.config.toolbarCanCollapse) {
              ...
              t.push(
                '<a title="' +
                  (u ? o.lang.toolbarCollapse : o.lang.toolbarExpand) +
                  '" id="' +
                  L +
              ...
              t.push(
                '" onclick="CKEDITOR.tools.callFunction(' + K + ')">',
                "<span>&#9650;</span>",
                "</a>"
              );
            }
        ...
        if (w || x) {
          ...
          for (var y = 0; y < w.length; y++) {
            var z = w[y],
              A = x[y];
            if (
              z.startOffset != A.startOffset ||
              z.endOffset != A.endOffset ||
              !e.arrayCompare(z.start, A.start) ||
              !e.arrayCompare(z.end, A.end)
            )
              return false;
          }
        }
  ...
  (function () {
      ...
      if (c) {
        ...
        if (L.type == "Control") L.clear();
          ...
          if (
            M &&
            M.type == 1 &&
            M.getAttribute("contenteditable") == "false" &&
            G.checkBoundaryOfElement(M, 2)
          ) {
    ...
    function t(E) {
      var F = this.getSelection(),
        G = F.getStartElement().hasAscendant("pre", true)
          ? 2
          : this.config.enterMode,
        H = G == 2,
    ...
    function C(E) {
      ...
      if (
        !J ||
        (J == 1 && I.type == 1 && I.hasAttribute("_moz_editor_bogus_node"))
      ) {
        v(E);
    ...
    j.add("wysiwygarea", {
      ...
      init: function (E) {
        var F =
            E.config.enterMode != 2 && E.config.autoParagraph !== false
              ? E.config.enterMode == 3
                ? "div"
                : "p"
              : false,
        ...
        E.on("editingBlockReady", function () {
          var M,
            ...
            U = function (X) {
              ...
              var Z = e.getNextId();
              N = h.createFromHtml(
                '<iframe style="width:100%;height:100%" frameBorder="0" aria-describedby="' +
                  Z +
                  '"' +
                  ' title="' +
                  G +
          ...
          function W(X) {
            ...
            ab &&
              Y.on("dblclick", function (ag) {
                var ah = ag.data.getTarget(),
                  ai = { element: ah, dialog: "" };
              ...
              Y.on("keydown", function (ag) {
                ...
                if (ah in { 8: 1, 46: 1 }) {
                  ...
                  if (aj) {
                    ...
                    (am = al.block) &&
                    ak[ap ? "checkStartOfBlock" : "checkEndOfBlock"]() &&
                    (ao = am[ap ? "getPrevious" : "getNext"](n)) &&
                    ao.is("table")
                  ) {
                    E.fire("saveSnapshot");
                    ...
                    al.blockLimit.is("td") &&
                    (an = al.blockLimit.getAscendant("table")) &&
                    ak.checkBoundaryOfElement(an, ap ? 1 : 2) &&
                    (ao = an[ap ? "getPrevious" : "getNext"](n))
                  ) {
                    E.fire("saveSnapshot");
                    ak["moveToElementEdit" + (ap ? "End" : "Start")](ao);
            ...
            if (c && E.config.enterMode != 1)
              Y.on("selectionchange", function () {
                ...
                if (
                  ai &&
                  ag.getHtml().match(/^<p>&nbsp;<\/p>$/i) &&
                  ai.startContainer.equals(ag)
                )
                  setTimeout(function () {
            ...
            if (E.contextMenu)
              E.contextMenu.addTarget(
                Y,
                E.config.browserContextMenuOnCtrl !== false
              );
            setTimeout(function () {
              E.fire("contentDom");
              if (R) {
              ...
              try {
                E.document.$.execCommand(
                  ...
                  false,
                  !E.config.disableNativeTableHandles
                );
              } catch (ah) {}
          ...
          E.addMode("wysiwyg", {
            ...
            loadData: function (X) {
              ...
              var ac = Y.baseHref
                ? '<base href="' + Y.baseHref + '" data-cke-temp="1" />'
                : "";
              if (Z)
              ...
              if (Z) {
                ...
                X =
                  Y.docType +
                  '<html dir="' +
                  Y.contentsLangDirection +
                  '"' +
                  ' lang="' +
                  (Y.contentsLanguage || E.langCode) +
                  '">' +
                  "<head>" +
                  "<title>" +
                  G +
                  ...
                  "</head>" +
                  "<body" +
                  (Y.bodyId ? ' id="' + Y.bodyId + '"' : "") +
                  (Y.bodyClass ? ' class="' + Y.bodyClass + '"' : "") +
                  ">" +
                  X +
                  "</html>";
              if (b.gecko)
            ...
            getData: function () {
              var X = E.config,
                ...
                ac = Y
                  ? ab.getDocumentElement().getOuterHtml()
                  : ab.getBody().getHtml();
        ...
        if (a.document.$.documentMode >= 8) {
          ...
          c &&
          b.version < 8 &&
          E.config.contentsLangDirection == "ltr"
        )
        ...
        E.on("insertElement", function (M) {
          ...
          if (N.type == 1 && (N.is("input") || N.is("textarea"))) {
            ...
            if (!O) {
              N.data(
                "cke-editable",
                N.hasAttribute("contenteditable") ? "true" : "1"
              );
  ...
  j.add("wsc", {
    ...
    init: function (m) {
      ...
      o.modes = {
        wysiwyg:
          !b.opera && !b.air && document.domain == window.location.hostname,
      };
  ...
  (function () {
    ...
    a.dialog = function (Q, R) {
      ...
      function ak(aq) {
        ...
        if (ar == 9 || ar == 2228224 + 9) {
          ...
          if (
            !aw.is("a", "button", "select") &&
            (!aw.is("input") || aw.$.type != "button")
          ) {
            at = ax.getButton("ok");
          ...
          else if (ax.fire("cancel", { hide: true }).hide !== false) ax.hide();
          Z = 1;
        } else return;
        al(aq);
      }
          ...
          if (Q.config.dialog_startupFocusTab && ag._.pageCount > 1) {
            ...
            if (au._.editor.mode == "wysiwyg" && c) {
              ...
              if (as)
                if (
                  (as.parentElement &&
                    as.parentElement().ownerDocument == Q.document.$) ||
      ...
      var ao = [],
        ap = a.dialog._.uiElementBuilders.hbox
          .build(
            this,
            {
              type: "hbox",
    ...
    a.dialog.prototype = {
      ...
      resize: (function () {
        return function (Q, R) {
          ...
          if (
            S._.contentSize &&
            S._.contentSize.width == Q &&
            S._.contentSize.height == R
          )
            return;
          a.dialog.fire(
            "resize",
            { dialog: S, skin: S._.editor.skinName, width: Q, height: R },
            S._.editor
          );
          S.fire(
            "resize",
            { skin: S._.editor.skinName, width: Q, height: R },
            S._.editor
          );
          if (S._.editor.lang.dir == "rtl" && S._.position)
            S._.position.x =
              a.document.getWindow().getViewPaneSize().width -
              S._.contentSize.width -
              parseInt(S._.element.getFirst().getStyle("right"), 10);
      ...
      layout: function () {
        ...
        var Q = a.document.getWindow().getViewPaneSize(),
          R = S.getSize();
        S.move(
          S._.moved ? S._.position.x : (Q.width - R.width) / 2,
          S._.moved ? S._.position.y : (Q.height - R.height) / 2
        );
      },
      foreach: function (Q) {
        var T = this;
      ...
      addPage: function (Q) {
        ...
        var R = [],
          ...
          T = Q.elements,
          U = a.dialog._.uiElementBuilders.vbox.build(
            ac,
            {
              type: "vbox",
        ...
        var W = b,
          ...
          Y = h.createFromHtml(
            [
              ...
              ac._.pageCount > 0 ? " cke_last" : "cke_first",
              S,
              !!Q.hidden ? ' style="display:none"' : "",
              ' id="',
              X,
              '"',
              W.gecko && W.version >= 10900 && !W.hc
                ? ""
      ...
      updateStyle: function () {
        this.parts.dialog[
          (this._.pageCount === 1 ? "add" : "remove") + "Class"
        ]("cke_single_page");
      },
      hidePage: function (Q) {
        var S = this;
    ...
    function B(Q) {
      ...
      var T = Q.getParentEditor(),
        ...
        aa = e.addFunction(function (ad) {
          ...
          V =
            Y.height -
            Q.parts.contents.getSize(
              "height",
              !(b.gecko || b.opera || (c && b.quirks))
            );
    ...
    function G(Q) {
      ...
      if (!X) {
        var Y = [
          ...
          b.ie6Compat ? "absolute" : "fixed",
          "; z-index: ",
          V,
          "; top: 0px; left: 0px; ",
          !b.ie6Compat ? "background-color: " + T : "",
        ...
        if (b.ie6Compat) {
          ...
          Y.push(
            "void((function(){document.open();" +
              (Z ? "document.domain='" + document.domain + "';" : "") +
              "document.write( '" +
              aa +
              "' );" +
              "document.close();" +
    ...
    (function () {
      k.dialog = {
        uiElement: function (Q, R, S, T, U, V, W) {
          ...
          var ag =
            aa["class"] && aa["class"].split ? aa["class"].split(" ") : [];
          ...
          Q.on("load", function () {
            ...
            if (al) {
              var am =
                ak.type in { checkbox: 1, ratio: 1 } && c && b.version < 8
          ...
          var V = (this._.children = R),
            ...
            Y = function () {
              ...
              Z.push(
                ...
                e.htmlEncode(
                  (U && U.align) ||
                    (Q.getParentEditor().lang.dir == "ltr" ? "left" : "right")
                ),
                '" '
              );
              Z.push("><tbody>");
    ...
    k.dialog.uiElement.prototype = {
      ...
      selectParentTab: function () {
        ...
        while (
          (R = R.getParent()) &&
          R.$.className.search("cke_dialog_page_contents") == -1
        ) {}
        if (!R) return T;
    ...
    k.dialog.hbox.prototype = e.extend(
      new k.dialog.uiElement(),
      {
        getChild: function (Q) {
          var R = this;
          ...
          if (Q.length < 2) return R._.children[Q[0]];
            ...
            return R._.children[Q[0]] && R._.children[Q[0]].getChild
              ? R._.children[Q[0]].getChild(Q.slice(1, Q.length))
              : null;
        },
      },
      true
  ...
  j.add("styles", {
    ...
    init: function (m) {
      m.on("contentDom", function () {
        m.document.setCustomData(
          "cke_includeReadonly",
          !m.config.disableReadonlyStyling
        );
      });
    },
  });
  ...
  (function () {
    ...
    a.style.prototype = {
      ...
      applyToRange: function (T) {
        var U = this;
        return (U.applyToRange =
          U.type == 2 ? t : U.type == 1 ? x : U.type == 3 ? v : null).call(
          U,
          T
        );
      },
      removeFromRange: function (T) {
        var U = this;
        return (U.removeFromRange =
          U.type == 2 ? u : U.type == 1 ? y : U.type == 3 ? w : null).call(
          U,
          T
        );
      },
      ...
      while (af) {
        ...
        if (af.equals(ae)) {
          ...
          if (
            ...
            (ab[al] &&
              !an &&
              (!am || aa) &&
              (af.getPosition(ae) | 4 | 0 | 8) == 4 + 0 + 8 &&
              (!X.childRule || X.childRule(af)))
          ) {
            var ao = af.getParent();
            if (
              ao &&
              ((ao.getDtd() || f.span)[W] || Y) &&
              (!X.parentRule || X.parentRule(ao))
            ) {
              if (
                !ag &&
                (!al ||
              ...
              if (ak == 3 || am || (ak == 1 && !af.getChildCount())) {
                ...
                while (
                  (aj = !ap.getNext(q)) &&
                  ((aq = ap.getParent()), ab[aq.getName()]) &&
                  (aq.getPosition(ad) | 2 | 0 | 8) == 2 + 0 + 8 &&
                  (!X.childRule || X.childRule(aq))
                )
                  ap = aq;
                ag.setEndAfter(ap);
              }
        ...
        if (aj && ag && !ag.collapsed) {
          var ar = J(ay, U),
            ...
            au = { styles: {}, attrs: {}, blockedStyles: {}, blockedAttrs: {} },
            av,
            aw,
            ax;
          while (ar && at) {
      ...
      if (T.collapsed) {
        ...
        for (var Y = 0, Z; Y < W.elements.length && (Z = W.elements[Y]); Y++) {
          ...
          if (this.checkElementRemovable(Z)) {
            ...
            if (
              T.collapsed &&
              (T.checkBoundaryOfElement(Z, 2) ||
                (aa = T.checkBoundaryOfElement(Z, 1)))
            ) {
              X = Z;
        ...
        if (Y.checkElementRemovable(W))
          if (W.is("pre")) {
            var X =
              Y._.enterMode == 2
                ? null
                : T.document.createElement(Y._.enterMode == 1 ? "p" : "div");
    ...
    function F(T, U) {
      ...
      for (var aa in W) {
        if (
          (aa == "class" || T._.definition.fullMatch) &&
          U.getAttribute(aa) != O(aa, W[aa])
        )
          continue;
        Z = U.hasAttribute(aa);
      ...
      H(U, Y, m[U.getName()]);
      if (Z)
        !f.$block[U.getName()] || (T._.enterMode == 2 && !U.hasAttributes())
          ? I(U)
          : U.renameNode(T._.enterMode == 1 ? "p" : "div");
    }
    function G(T, U) {
      var V = T._.definition,
        W = V.attributes,
    ...
    function R(T, U) {
      ...
      for (var V in T) {
        if (
          !(V in U && (U[V] == T[V] || T[V] == "inherit" || U[V] == "inherit"))
        )
          return false;
      }
      return true;
  ...
  a.editor.prototype.getStylesSet = function (m) {
    if (!this._.stylesDefinitions) {
      ...
      a.stylesSet.addExternal(
        q,
        r ? p.slice(1).join(":") : s + "styles/" + q + ".js",
        ""
      );
    ...
    m.prototype = {
      getNextParagraph: function (s) {
        ...
        if (!S._.started) {
          ...
          u.shrink(1, true);
          w =
            u.endContainer.hasAscendant("pre", true) ||
          ...
          if (!u.collapsed) {
            ...
            if (
              S._.lastNode &&
              S._.lastNode.type == 3 &&
              !e.trim(S._.lastNode.getText()) &&
              S._.lastNode.getParent().isBlockBoundary()
            ) {
        ...
        if (!t) {
          ...
          if (
            ...
            S._.nextNode = t.equals(B)
              ? null
              : r(u.getBoundaryNodes().endNode, 1, B);
        }
        if (x) {
          var Q = t.getPrevious();
          if (Q && Q.type == 1)
    ...
    k.floatPanel = e.createClass({
      ...
      proto: {
        ...
        showBlock: function (p, q, r, s, t) {
          ...
          n = 1;
          this._.returnFocus = this._.editor.focusManager.hasFocus
            ? this._.editor
            : new h(a.document.$.activeElement);
          var w = this.element,
            x = this._.iframe,
            y = this._.definition,
              ...
              var E = e.bind(function () {
                ...
                if (c) {
                  ...
                  if (U.getComputedStyle("direction") == "rtl")
                    if (b.ie8Compat)
                      B -=
                        w.getDocument().getDocumentElement().$.scrollLeft * 2;
        ...
        showAsChild: function (p, q, r, s, t, u) {
          if (
            ...
            p._.panel._.offsetParentId == r.getId()
          )
            return;
          this.hideChild();
      ...
      _: {
        ...
        showSubMenu: function (n) {
          ...
          if (o) o.removeAll();
            ...
            o = v._.subMenu = new a.menu(
              v.editor,
              e.extend({}, v._.definition, { level: v._.level + 1 }, true)
            );
            o.parent = v;
      ...
      proto: {
        ...
        show: function (n, o, p, q) {
          ...
          var r = this.items,
            ...
            u = this._.element;
          if (!t) {
            t = this._.panel = new k.floatPanel(
              this.editor,
              a.document.getBody(),
            ...
            this._.itemOverFn = e.addFunction(function (F) {
              ...
              G._.showSubTimeout = e.setTimeout(
                G._.showSubMenu,
                s.config.menu_subMenuDelay || 400,
                G,
                [F]
              );
            }, this);
          ...
          var y = s.container.getChild(1),
            z = y.hasClass("cke_mixed_dir_content")
        ...
        render: function (n, o, p) {
          ...
          p.push(
            ...
            '" tabindex="-1"_cke_focus=1 hidefocus="true" role="menuitem"' +
              ...
              (r == 0 ? 'aria-disabled="true"' : "") +
              (r == 1 ? 'aria-pressed="true"' : "")
          );
          ...
          p.push(
            ' onmouseover="CKEDITOR.tools.callFunction(',
            n._.itemOverFn,
            ",",
            o,
            ');" onmouseout="CKEDITOR.tools.callFunction(',
            n._.itemOutFn,
            ",",
            o,
            ');" ' +
          ...
          if (u)
            p.push(
              ...
              "<span>&#",
              w.editor.lang.dir == "rtl" ? "9668" : "9658",
              ";</span>",
              "</span>"
            );
  ...
  (function () {
    ...
    function r(z) {
      ...
      return !e.trim(C.getHtml())
        ? A(C) || B(C)
        : A(C.getChild(D - 1)) || A(C.getChild(D));
    }
    var s = {
      modes: { wysiwyg: 1, source: 1 },
      readOnly: c || b.webkit,
              ...
              G.on("mousedown", function (O) {
                function P(R) {
                  ...
                  if (Q) {
                    ...
                    L(S, R.x, R.y);
                    Q.setEndPoint(
                      Q.compareEndPoints("StartToStart", S) < 0
                        ? "EndToEnd"
                        : "StartToStart",
                      S
                    );
                ...
                if (
                  O.y < G.$.clientHeight &&
                  O.y > F.$.offsetTop + F.$.clientHeight &&
                  O.x < G.$.clientWidth
                ) {
            ...
            if (b.ie8)
              G.on("mouseup", function (O) {
                if (O.data.getTarget().getName() == "html") {
                  ...
                  if (
                    P.type != "None" &&
                    Q.parentElement().ownerDocument == E.$
                  )
                    Q.select();
                }
              });
            ...
            function N(O) {
              if (I) {
                ...
                if (
                  ...
                  (S = S.parentElement()) &&
                  (S = S.nodeName) &&
                  S.toLowerCase() in { input: 1, textarea: 1 }
                )
                  return;
                H = R && Q.getRanges()[0];
                p.call(z);
    ...
    d.selection = function (z) {
      ...
      if (c)
        try {
          ...
          if (
            !B ||
            (B.item && B.item(0).ownerDocument != C.document.$) ||
            (B.parentElement && B.parentElement().ownerDocument != C.document.$)
          )
            throw 0;
        } catch (D) {
          C.isInvalid = true;
    ...
    d.selection.prototype = {
      getNative: c
        ...
        : function () {
            return (
              this._.cache.nativeSel ||
              (this._.cache.nativeSel = this.document
                .getWindow()
                .$.getSelection())
            );
          },
          ...
          ? (function () {
              ...
              return function () {
                ...
                if (E == 2) {
                  ...
                  if (
                    F.endContainer.getPosition(F.startContainer) & 4 &&
            ...
            for (var D = 0; D < C.length; D++) {
              ...
              if (E.startContainer.isReadOnly()) {
                ...
                while (G) {
                  ...
                  if (
                    G.type == 1 &&
                    G.getAttribute("contentEditable") == "false"
                  )
                    E.setStartAfter(G);
                  G = G.getParent();
                }
            ...
            if (C) {
              if (!C.collapsed) {
                ...
                while (1) {
                  ...
                  if (
                    E ==
                      (D.getChildCount ? D.getChildCount() : D.getLength()) &&
                    !D.isBlockBoundary()
                  )
                    C.setStartAfter(D);
                  else break;
      ...
      selectRanges: function (z) {
        ...
        if (c) {
          ...
          for (var C = 0; C < z.length; C++) {
            ...
            if (
              I.collapsed &&
              (b.opera || (b.gecko && b.version < 10900)) &&
              K.type == 1 &&
              !K.getChildCount()
            )
              K.appendText("");
  ...
  (function () {
    ...
    d.range.prototype.select = c
      ? function (p) {
          ...
          if (
            (A.startContainer.type == 1 && A.startContainer.getName() in o) ||
            (A.endContainer.type == 1 && A.endContainer.getName() in o)
          )
            A.shrink(1, true);
          ...
          if (x) {
            ...
            var z = w.getNext(m);
            r =
              !(z && z.getText && z.getText().match(n)) &&
              (p ||
                !w.hasPrevious() ||
                (w.getPrevious().is && w.getPrevious().is("br")));
  ...
  (function () {
    ...
    a.editor.prototype.restoreRealElement = function (r) {
      ...
      var s = h.createFromHtml(
        decodeURIComponent(r.data("cke-realelement")),
        this.document
      );
  ...
  k.richCombo = e.createClass({
    ...
    proto: {
      ...
      render: function (m, n) {
        ...
        n.push(
          ' role="presentation">',
          '<span id="' + p + '_label" class=cke_label>',
          this.label,
          "</span>",
          '<a hidefocus=true title="',
          this.title,
          '" tabindex="-1"',
          o.gecko && o.version >= 10900 && !o.hc
            ? ""
        ...
        n.push(
          ...
          t,
          ', event, this );" onfocus="return CKEDITOR.tools.callFunction(',
          u,
          ', event);" ' +
            (c ? 'onclick="return false;" onmouseup' : "onclick") +
            '="CKEDITOR.tools.callFunction(',
          q,
          ', this); return false;"><span><span id="' +
            p +
            '_text" class="cke_text cke_inline_label">' +
            this.label +
            "</span>" +
            "</span>" +
            "<span class=cke_openbutton><span class=cke_icon>" +
            (b.hc ? "&#9660;" : b.air ? "&nbsp;" : "") +
            "</span></span>" +
            "</a>" +
            "</span>" +
  ...
  (function () {
      ...
      k.dialog,
      {
          ...
          var z = (this._.children = []),
            A = function () {
              ...
              if (v.labelLayout != "horizontal")
                B.push(
                  '<label class="cke_dialog_ui_labeled_label' + C + '" ',
                  ' id="' + y.labelId + '"',
                  y.inputId ? ' for="' + y.inputId + '"' : "",
                  (v.labelStyle ? ' style="' + v.labelStyle + '"' : "") + ">",
                  v.label,
                  "</label>",
                  '<div class="cke_dialog_ui_labeled_content"' +
                    (v.controlStyle ? ' style="' + v.controlStyle + '"' : "") +
                    ' role="presentation">',
                  x.call(this, u, v),
                  "</div>"
                );
        ...
        textInput: function (u, v, w) {
          ...
          var x = (this._.inputId = e.getNextId() + "_textInput"),
            y = { class: "cke_dialog_ui_input_" + v.type, id: x, type: v.type },
            z;
        ...
        textarea: function (u, v, w) {
          ...
          var A = function () {
            ...
            var B = [
              '<div class="cke_dialog_ui_input_textarea" role="presentation"><textarea class="cke_dialog_ui_input_textarea" id="',
              y,
              '" ',
            ];
            ...
            z = function () {
              ...
              for (var E = 0; E < v.items.length; E++) {
                var F = v.items[E],
                  ...
                  J = I + "_label",
                  K = e.extend({}, v, { id: I, title: null, type: null }, true),
                  L = e.extend({}, K, { title: G }, true),
                  M = {
                    type: "radio",
          ...
          var y = function () {
            ...
            for (var D = 0, E; D < v.items.length && (E = v.items[D]); D++)
              B.push(
                '<option value="',
                e
                  .htmlEncode(E[1] !== undefined ? E[1] : E[0])
                  .replace(/"/g, "&quot;"),
                '" /> ',
                e.htmlEncode(E[0])
              );
            if (typeof z.inputStyle != "undefined") z.style = z.inputStyle;
            x.select = new k.dialog.uiElement(
              u,
              z,
              A,
              "select",
        ...
        fileButton: function (u, v, w) {
          ...
          var z = e.extend({}, v),
            A = z.onClick;
          z.className =
            (z.className ? z.className + " " : "") + "cke_dialog_ui_button";
          ...
          var z = y.label,
            A = function () {
              ...
              z &&
                B.push(
                  "<legend" +
                    (y.labelStyle ? ' style="' + y.labelStyle + '"' : "") +
                    ">" +
                    z +
                    "</legend>"
                );
    ...
    k.dialog.labeledElement.prototype = e.extend(
      new k.dialog.uiElement(),
      {
        setLabel: function (u) {
    ...
    k.dialog.button.prototype = e.extend(
      new k.dialog.uiElement(),
      {
        click: function () {
          var u = this;
    ...
    k.dialog.textInput.prototype = e.extend(
      new k.dialog.labeledElement(),
      {
        getInputElement: function () {
    ...
    k.dialog.select.prototype = e.extend(
      new k.dialog.labeledElement(),
      {
        getInputElement: function () {
    ...
    k.dialog.checkbox.prototype = e.extend(
      new k.dialog.uiElement(),
      {
        getInputElement: function () {
    ...
    k.dialog.radio.prototype = e.extend(
      new k.dialog.uiElement(),
      {
        setValue: function (u, v) {
    ...
    k.dialog.file.prototype = e.extend(
      new k.dialog.labeledElement(),
      q,
      {
        getInputElement: function () {
          var u = a.document.getById(this._.frameId).getFrameDocument();
          return u.$.forms.length > 0
            ? new h(u.$.forms[0].elements[0])
            : this.getElement();
        },
        submit: function () {
          ...
          function D() {
            ...
            w.$.write(
              [
                ...
                u.labelId,
                '" type="file" name="',
                e.htmlEncode(x.id || "cke_upload"),
                '" size="',
                e.htmlEncode(E > 0 ? E : ""),
                '" />',
                "</form>",
                "</body></html>",
                "<script>window.parent.CKEDITOR.tools.callFunction(" + z + ");",
  ...
  k.panel.prototype = {
    ...
    render: function (m, n) {
      ...
      if (p.forceIFrame || p.css.length) {
        n.push(
          '<iframe id="',
          o,
          '_frame" frameborder="0" role="application" src="javascript:void('
        );
        n.push(
          b.isCustomDomain()
            ? "(function(){document.open();document.domain='" +
        ...
        if (this.forceIFrame || this.css.length) {
          ...
          var t = e.addFunction(
            ...
            u =
              ...
              ' onload="( window.CKEDITOR || window.parent.CKEDITOR ).tools.callFunction(' +
              t +
              ');"></body>' +
              "</html>";
          s.write(u);
    ...
    addBlock: function (m, n) {
      var o = this;
      n = o._.blocks[m] =
        n instanceof k.panel.block
          ? n
          : new k.panel.block(o.getHolderElement(), n);
    ...
    showBlock: function (m) {
      ...
      var n = r._.blocks,
        ...
        q =
          !r.forceIFrame || c
            ? r._.holder
            : r.document.getById(r.id + "_frame");
      if (p) {
        ...
        proto: {
          add: function (m, n, o) {
            ...
            p.push(
              "<li id=",
              q,
              ' class=cke_panel_listItem role=presentation><a id="',
              q,
              '_option" _cke_focus=1 hidefocus=true title="',
              o || m,
              '" href="javascript:void(\'',
              m,
              "')\" " +
          ...
          startGroup: function (m) {
            ...
            this._.pendingHtml.push(
              '<h1 role="presentation" id=',
              n,
              " class=cke_panel_grouptitle>",
              m,
              "</h1>"
            );
          },
    ...
    (function () {
      ...
      return {
        build: function (o, p) {
          ...
          if (!r || s == 0) return;
          if (s == 1) r.hide();
          var t = o.fire("themeSpace", { space: "top", html: "" }).html,
            u = o.fire("themeSpace", { space: "contents", html: "" }).html,
            v = o.fireOnce("themeSpace", { space: "bottom", html: "" }).html,
            w = u && o.config.height,
            ...
            q = h.createFromHtml(
              [
                ...
                '" style="position:absolute" role="presentation"><tr><td role="presentation"><div class="%body" role="presentation"><div id="%title#" class="%title" role="presentation"></div><a id="%close_button#" class="%close_button" href="javascript:void(0)" title="' +
                  ...
                  "</td></tr>" +
                  "</table>",
                c ? "" : "<style>.cke_dialog{visibility:hidden;}</style>",
                "</div>",
              ]
                .join("")
                .replace(/#/g, "_" + p)
          ...
          if (c && !b.ie6Compat) {
            var u = b.isCustomDomain(),
              v =
                ...
                encodeURIComponent(
                  "document.open();" +
                    (u ? 'document.domain="' + document.domain + '";' : "") +
                    "document.close();"
                ) +
                "}())",
              w = h.createFromHtml(
